...
std::cout << "input starts" << std::endl;
 arma::mat Rinv_1 = RcppDeepState_mat ();
  Rinv_1_stream.open("/home/akhila/Documents/compileAttributescheck/BGGM/inst/testfiles/sum_squares/inputs/ Rinv_1");
 Rinv_1_stream<< Rinv_1;
std::cout <<"Rinv_1 values: "<< Rinv_1 << std::endl;
 Rinv_1_stream.close();
 arma::mat Rinv_2 = RcppDeepState_mat ();
  Rinv_2_stream.open("/home/akhila/Documents/compileAttributescheck/BGGM/inst/testfiles/sum_squares/inputs/ Rinv_2");
