...
std::ofstream  hk_stream;
 ...
 int n_steps = RcppDeepState_int ();
  n_steps_stream.open("/home/akhila/Documents/compileAttributescheck/amt/inst/testfiles/simulate_udf/inputs/ n_steps");
 n_steps_stream<< n_steps;
std::cout <<"n_steps values: "<< n_steps << std::endl;
 n_steps_stream.close();
 int start = RcppDeepState_int ();
  start_stream.open("/home/akhila/Documents/compileAttributescheck/amt/inst/testfiles/simulate_udf/inputs/ start");
 start_stream<< start;
std::cout <<"start values: "<< start << std::endl;
 start_stream.close();
 int nc = RcppDeepState_int ();
  nc_stream.open("/home/akhila/Documents/compileAttributescheck/amt/inst/testfiles/simulate_udf/inputs/ nc");
 nc_stream<< nc;
std::cout <<"nc values: "<< nc << std::endl;
 nc_stream.close();
 int nr = RcppDeepState_int ();
  nr_stream.open("/home/akhila/Documents/compileAttributescheck/amt/inst/testfiles/simulate_udf/inputs/ nr");
 nr_stream<< nr;
std::cout <<"nr values: "<< nr << std::endl;
 nr_stream.close();
 NumericMatrix mk = RcppDeepState_NumericMatrix ();
  mk_stream.open("/home/akhila/Documents/compileAttributescheck/amt/inst/testfiles/simulate_udf/inputs/ mk");
 mk_stream<< mk;
std::cout <<"mk values: "<< mk << std::endl;
 mk_stream.close();
 NumericMatrix hk = RcppDeepState_NumericMatrix ();
  hk_stream.open("/home/akhila/Documents/compileAttributescheck/amt/inst/testfiles/simulate_udf/inputs/ hk");
 hk_stream<< hk;
std::cout <<"hk values: "<< hk << std::endl;
 hk_stream.close();
 std::cout << "input ends" << std::endl;
 try{
simulate_udf( n_steps, start, nc, nr, mk, hk);
}
