...
std::cout << "input starts" << std::endl;
 NumericVector tt1 = RcppDeepState_NumericVector ();
  tt1_stream.open("/home/akhila/Documents/compileAttributescheck/bcROCsurface/inst/testfiles/vusC_full/inputs/ tt1");
 tt1_stream<< tt1;
std::cout <<"tt1 values: "<< tt1 << std::endl;
 tt1_stream.close();
 NumericVector tt2 = RcppDeepState_NumericVector ();
  tt2_stream.open("/home/akhila/Documents/compileAttributescheck/bcROCsurface/inst/testfiles/vusC_full/inputs/ tt2");
 tt2_stream<< tt2;
std::cout <<"tt2 values: "<< tt2 << std::endl;
 tt2_stream.close();
 NumericVector tt3 = RcppDeepState_NumericVector ();
  tt3_stream.open("/home/akhila/Documents/compileAttributescheck/bcROCsurface/inst/testfiles/vusC_full/inputs/ tt3");
 tt3_stream<< tt3;
