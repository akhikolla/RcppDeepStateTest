...
valgrind_afl_test <- function(pkg.i){
  afl.res.list<- list()
    package.path <- pkg.i 
...
y <- paste0("/home/akhila/fuzzer_packages/fuzzedpackages/",names(pkg.unexlist))
  ...
  future.apply::future_lapply(y, FUN=valgrind_afl_test)
...
"~/fuzzer_packages/fuzzedpackages/nanotime/inst/testfiles/ceiling_impl/AFL_ceiling_impl/ceiling_impl_valgrind_files"