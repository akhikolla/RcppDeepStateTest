...
TEST(BNSL_deepstate_test,gc_all_test){
  ...
  qs::c_qsave(cc,"/home/akhila/RcppDeepStateTest/BNSL/inst/testfiles/gc_all/inputs/cc.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "cc values: "<< cc << std::endl;
  std::ofstream a_stream;
  double a  = RcppDeepState_double();
  a_stream.open("/home/akhila/RcppDeepStateTest/BNSL/inst/testfiles/gc_all/inputs/a");
  a_stream << a;
