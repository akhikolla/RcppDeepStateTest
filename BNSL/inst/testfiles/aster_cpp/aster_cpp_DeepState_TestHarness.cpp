...
TEST(BNSL_deepstate_test,aster_cpp_test){
  ...
  qs::c_qsave(matrix,"/home/akhila/RcppDeepStateTest/BNSL/inst/testfiles/aster_cpp/inputs/matrix.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "matrix values: "<< matrix << std::endl;
  std::ofstream tree_width_stream;
  int tree_width  = RcppDeepState_int();
  tree_width_stream.open("/home/akhila/RcppDeepStateTest/BNSL/inst/testfiles/aster_cpp/inputs/tree_width");
  ...
  proc_stream.open("/home/akhila/RcppDeepStateTest/BNSL/inst/testfiles/aster_cpp/inputs/proc");
  proc_stream << proc;
  std::cout << "proc values: "<< proc << std::endl;
  proc_stream.close();
  std::ofstream s_stream;
  double s  = RcppDeepState_double();
  s_stream.open("/home/akhila/RcppDeepStateTest/BNSL/inst/testfiles/aster_cpp/inputs/s");
  s_stream << s;
  std::cout << "s values: "<< s << std::endl;
  s_stream.close();
  std::ofstream n_stream;
  int n  = RcppDeepState_int();
  n_stream.open("/home/akhila/RcppDeepStateTest/BNSL/inst/testfiles/aster_cpp/inputs/n");
  n_stream << n;
  std::cout << "n values: "<< n << std::endl;
  n_stream.close();
  std::ofstream ss_stream;
  int ss  = RcppDeepState_int();
  ss_stream.open("/home/akhila/RcppDeepStateTest/BNSL/inst/testfiles/aster_cpp/inputs/ss");
  ss_stream << ss;
