...
TEST(BNSL_deepstate_test,fftable_test){
  ...
  qs::c_qsave(df,"/home/akolla/extdata/packages/BNSL/inst/testfiles/fftable/inputs/df.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "df values: "<< df << std::endl;
  std::ofstream w_stream;
  int w  = RcppDeepState_int();
  w_stream.open("/home/akolla/extdata/packages/BNSL/inst/testfiles/fftable/inputs/w");
  w_stream << w;
