...
TEST(BNSL_deepstate_test,binary_search_test){
  ...
  qs::c_qsave(array,"/home/akhila/RcppDeepStateTest/BNSL/inst/testfiles/binary_search/inputs/array.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "array values: "<< array << std::endl;
  std::ofstream pattern_stream;
  double pattern  = RcppDeepState_double();
  pattern_stream.open("/home/akhila/RcppDeepStateTest/BNSL/inst/testfiles/binary_search/inputs/pattern");
