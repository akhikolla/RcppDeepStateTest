...
std::ofstream  ct_stream;
 ...
 NumericVector design1 = RcppDeepState_NumericVector ();
  design1_stream.open("/home/akhila/Documents/compileAttributescheck/activegp/inst/testfiles/grad_W_kappa_ij2_w2/inputs/ design1");
...
std::cout <<"design1 values: "<< design1 << std::endl;
 ...
 NumericMatrix design2 = RcppDeepState_NumericMatrix ();
  design2_stream.open("/home/akhila/Documents/compileAttributescheck/activegp/inst/testfiles/grad_W_kappa_ij2_w2/inputs/ design2");
...
std::cout <<"design2 values: "<< design2 << std::endl;
 ...
 NumericVector theta = RcppDeepState_NumericVector ();
  theta_stream.open("/home/akhila/Documents/compileAttributescheck/activegp/inst/testfiles/grad_W_kappa_ij2_w2/inputs/ theta");
 theta_stream<< theta;
std::cout <<"theta values: "<< theta << std::endl;
 theta_stream.close();
 int i1 = RcppDeepState_int ();
  i1_stream.open("/home/akhila/Documents/compileAttributescheck/activegp/inst/testfiles/grad_W_kappa_ij2_w2/inputs/ i1");
 i1_stream<< i1;
std::cout <<"i1 values: "<< i1 << std::endl;
 i1_stream.close();
 int i2 = RcppDeepState_int ();
  i2_stream.open("/home/akhila/Documents/compileAttributescheck/activegp/inst/testfiles/grad_W_kappa_ij2_w2/inputs/ i2");
 i2_stream<< i2;
std::cout <<"i2 values: "<< i2 << std::endl;
 i2_stream.close();
 int ct = RcppDeepState_int ();
  ct_stream.open("/home/akhila/Documents/compileAttributescheck/activegp/inst/testfiles/grad_W_kappa_ij2_w2/inputs/ ct");
 ct_stream<< ct;
