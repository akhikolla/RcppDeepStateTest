...
std::ofstream  params_stream;
 ...
 NumericVector x1 = RcppDeepState_NumericVector ();
  x1_stream.open("/home/akhila/Documents/compileAttributescheck/backbone/inst/testfiles/scobit_loglike_gr_cpp/inputs/ x1");
 x1_stream<< x1;
std::cout <<"x1 values: "<< x1 << std::endl;
 x1_stream.close();
 NumericVector x2 = RcppDeepState_NumericVector ();
  x2_stream.open("/home/akhila/Documents/compileAttributescheck/backbone/inst/testfiles/scobit_loglike_gr_cpp/inputs/ x2");
 x2_stream<< x2;
std::cout <<"x2 values: "<< x2 << std::endl;
 x2_stream.close();
 NumericVector y = RcppDeepState_NumericVector ();
  y_stream.open("/home/akhila/Documents/compileAttributescheck/backbone/inst/testfiles/scobit_loglike_gr_cpp/inputs/ y");
 y_stream<< y;
std::cout <<"y values: "<< y << std::endl;
 y_stream.close();
 NumericVector params = RcppDeepState_NumericVector ();
  params_stream.open("/home/akhila/Documents/compileAttributescheck/backbone/inst/testfiles/scobit_loglike_gr_cpp/inputs/ params");
