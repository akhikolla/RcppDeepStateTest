...
std::ofstream  terminal_node_stream;
 ...
 NumericMatrix tree_matrix_temp = RcppDeepState_NumericMatrix ();
  tree_matrix_temp_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/find_term_obs_gs/inputs/ tree_matrix_temp");
...
std::cout <<"tree_matrix_temp values: "<< tree_matrix_temp << std::endl;
 ...
 double terminal_node = RcppDeepState_double ();
  terminal_node_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/find_term_obs_gs/inputs/ terminal_node");
