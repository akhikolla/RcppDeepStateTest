...
std::ofstream  sum_preds_stream;
 ...
 double low = RcppDeepState_double ();
  low_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/get_original_pred/inputs/ low");
 low_stream<< low;
std::cout <<"low values: "<< low << std::endl;
 low_stream.close();
 double high = RcppDeepState_double ();
  high_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/get_original_pred/inputs/ high");
 high_stream<< high;
std::cout <<"high values: "<< high << std::endl;
 high_stream.close();
 double sp_low = RcppDeepState_double ();
  sp_low_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/get_original_pred/inputs/ sp_low");
 sp_low_stream<< sp_low;
std::cout <<"sp_low values: "<< sp_low << std::endl;
 sp_low_stream.close();
 double sp_high = RcppDeepState_double ();
  sp_high_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/get_original_pred/inputs/ sp_high");
...
std::cout <<"sp_high values: "<< sp_high << std::endl;
 ...
 NumericVector sum_preds = RcppDeepState_NumericVector ();
  sum_preds_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/get_original_pred/inputs/ sum_preds");
