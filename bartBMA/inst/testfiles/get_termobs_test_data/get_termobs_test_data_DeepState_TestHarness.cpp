...
std::ofstream  tree_data_stream;
 ...
 NumericMatrix test_data = RcppDeepState_NumericMatrix ();
  test_data_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/get_termobs_test_data/inputs/ test_data");
...
std::cout <<"test_data values: "<< test_data << std::endl;
 ...
 NumericMatrix tree_data = RcppDeepState_NumericMatrix ();
  tree_data_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/get_termobs_test_data/inputs/ tree_data");
