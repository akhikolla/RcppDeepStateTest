...
std::ofstream  lambda_stream;
 ...
 NumericVector y_temp = RcppDeepState_NumericVector ();
  y_temp_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/likelihood_function/inputs/ y_temp");
 y_temp_stream<< y_temp;
std::cout <<"y_temp values: "<< y_temp << std::endl;
 y_temp_stream.close();
 NumericMatrix treetable_temp = RcppDeepState_NumericMatrix ();
  treetable_temp_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/likelihood_function/inputs/ treetable_temp");
...
std::cout <<"treetable_temp values: "<< treetable_temp << std::endl;
 ...
 NumericMatrix obs_to_nodes_temp = RcppDeepState_NumericMatrix ();
  obs_to_nodes_temp_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/likelihood_function/inputs/ obs_to_nodes_temp");
...
std::cout <<"obs_to_nodes_temp values: "<< obs_to_nodes_temp << std::endl;
 ...
 double a = RcppDeepState_double ();
  a_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/likelihood_function/inputs/ a");
 a_stream<< a;
std::cout <<"a values: "<< a << std::endl;
 a_stream.close();
 double mu = RcppDeepState_double ();
  mu_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/likelihood_function/inputs/ mu");
 mu_stream<< mu;
std::cout <<"mu values: "<< mu << std::endl;
 mu_stream.close();
 double nu = RcppDeepState_double ();
  nu_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/likelihood_function/inputs/ nu");
 nu_stream<< nu;
std::cout <<"nu values: "<< nu << std::endl;
 nu_stream.close();
 double lambda = RcppDeepState_double ();
  lambda_stream.open("/home/akhila/Documents/compileAttributescheck/bartBMA/inst/testfiles/likelihood_function/inputs/ lambda");
