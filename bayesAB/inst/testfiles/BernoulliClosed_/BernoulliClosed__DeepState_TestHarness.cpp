...
std::ofstream  beta_2_stream;
 ...
 double alpha_1 = RcppDeepState_double ();
  alpha_1_stream.open("/home/akhila/Documents/compileAttributescheck/bayesAB/inst/testfiles/BernoulliClosed_/inputs/ alpha_1");
 alpha_1_stream<< alpha_1;
std::cout <<"alpha_1 values: "<< alpha_1 << std::endl;
 alpha_1_stream.close();
 double beta_1 = RcppDeepState_double ();
  beta_1_stream.open("/home/akhila/Documents/compileAttributescheck/bayesAB/inst/testfiles/BernoulliClosed_/inputs/ beta_1");
 beta_1_stream<< beta_1;
std::cout <<"beta_1 values: "<< beta_1 << std::endl;
 beta_1_stream.close();
 double alpha_2 = RcppDeepState_double ();
  alpha_2_stream.open("/home/akhila/Documents/compileAttributescheck/bayesAB/inst/testfiles/BernoulliClosed_/inputs/ alpha_2");
 alpha_2_stream<< alpha_2;
std::cout <<"alpha_2 values: "<< alpha_2 << std::endl;
 alpha_2_stream.close();
 double beta_2 = RcppDeepState_double ();
  beta_2_stream.open("/home/akhila/Documents/compileAttributescheck/bayesAB/inst/testfiles/BernoulliClosed_/inputs/ beta_2");
