...
std::ofstream  numb_sample_stream;
 ...
 double est = RcppDeepState_double ();
  est_stream.open("/home/akhila/Documents/compileAttributescheck/alphabetr/inst/testfiles/likelihood_single/inputs/ est");
 est_stream<< est;
std::cout <<"est values: "<< est << std::endl;
 est_stream.close();
 double err = RcppDeepState_double ();
  err_stream.open("/home/akhila/Documents/compileAttributescheck/alphabetr/inst/testfiles/likelihood_single/inputs/ err");
 err_stream<< err;
std::cout <<"err values: "<< err << std::endl;
 err_stream.close();
 NumericVector numb_wells = RcppDeepState_NumericVector ();
  numb_wells_stream.open("/home/akhila/Documents/compileAttributescheck/alphabetr/inst/testfiles/likelihood_single/inputs/ numb_wells");
...
std::cout <<"numb_wells values: "<< numb_wells << std::endl;
 ...
 NumericVector numb_cells = RcppDeepState_NumericVector ();
  numb_cells_stream.open("/home/akhila/Documents/compileAttributescheck/alphabetr/inst/testfiles/likelihood_single/inputs/ numb_cells");
...
std::cout <<"numb_cells values: "<< numb_cells << std::endl;
 ...
 NumericVector numb_sample = RcppDeepState_NumericVector ();
  numb_sample_stream.open("/home/akhila/Documents/compileAttributescheck/alphabetr/inst/testfiles/likelihood_single/inputs/ numb_sample");
