...
List gibbs_norep(arma::vec y, arma::mat X, arma::mat Z,
  ...
  return List::create(Named("beta") = beta, Named("u") = u, Named("tau2") = tau2, Named("sigma2") = sigma2);
}



////////////////////////////////
//più componenti di varianza
////////////////////////////////


// [[Rcpp::export]]

List gibbs_norep_r(arma::vec y, arma::mat X, arma::mat Z,
