    ...
    max_ll_index) 
{
    ...
    e[["immer_ccml_gradient"]][[length(e[["immer_ccml_gradient"]]) + 
        1]] <- list(b = b, ll_index1 = ll_index1, item10 = item10, 
        item20 = item20, cat1 = cat1, cat2 = cat2, n = n, ntot = ntot, 
        max_ll_index = max_ll_index)
    .Call("_immer_immer_ccml_gradient", PACKAGE = "immer", b, 
        ll_index1, item10, item20, cat1, cat2, n, ntot, max_ll_index)
}
