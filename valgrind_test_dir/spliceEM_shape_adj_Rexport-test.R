    ...
    truncupper, eps, beta_tol, maxiter) 
{
    ...
    e[["spliceEM_shape_adj_Rexport"]][[length(e[["spliceEM_shape_adj_Rexport"]]) + 
        ...
        maxiter = maxiter)
    .Call("_ReIns_spliceEM_shape_adj_Rexport", pi, theta, shape, 
        beta, gamma, lower1, lower2, lower3, lower4, lower5, 
