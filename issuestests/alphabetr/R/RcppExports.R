...
dual_discrim_dual_likelihood <- function(est, err, numb_cells, numb_wells, binomials) {
    .Call('_alphabetr_dual_discrim_dual_likelihood', PACKAGE = 'alphabetr', est, err, numb_cells, numb_wells, binomials)
}
...
dual_discrim_shared_likelihood <- function(est1, est2, err, numb_cells, numb_wells, binomials, multinomials) {
    .Call('_alphabetr_dual_discrim_shared_likelihood', PACKAGE = 'alphabetr', est1, est2, err, numb_cells, numb_wells, binomials, multinomials)
}
...
likelihood_dual <- function(est, err, numb_wells, numb_cells, numb_sample) {
    .Call('_alphabetr_likelihood_dual', PACKAGE = 'alphabetr', est, err, numb_wells, numb_cells, numb_sample)
}
...
likelihood_dualdual <- function(est, err, numb_wells, numb_cells, numb_sample) {
    .Call('_alphabetr_likelihood_dualdual', PACKAGE = 'alphabetr', est, err, numb_wells, numb_cells, numb_sample)
}
...
likelihood_single <- function(est, err, numb_wells, numb_cells, numb_sample) {
    .Call('_alphabetr_likelihood_single', PACKAGE = 'alphabetr', est, err, numb_wells, numb_cells, numb_sample)
}
