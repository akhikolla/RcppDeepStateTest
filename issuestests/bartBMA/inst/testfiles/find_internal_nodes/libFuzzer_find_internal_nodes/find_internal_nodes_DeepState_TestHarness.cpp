...
TEST(bartBMA_deepstate_test,find_internal_nodes_test){
  ...
  std::string treetable_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/find_internal_nodes/libFuzzer_find_internal_nodes/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_treetable.qs";
