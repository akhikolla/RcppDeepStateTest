...
TEST(bartBMA_deepstate_test,set_tree_to_middle_test){
  ...
  std::string node_to_update_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/set_tree_to_middle/libFuzzer_set_tree_to_middle/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_node_to_update.qs";
  ...
  std::string prior_tree_table_temp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/set_tree_to_middle/libFuzzer_set_tree_to_middle/libfuzzer_inputs/" + std::to_string(current_timestamp) +
  ...
  std::string grow_node_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/set_tree_to_middle/libFuzzer_set_tree_to_middle/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_grow_node.qs";
  ...
  std::string left_daughter_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/set_tree_to_middle/libFuzzer_set_tree_to_middle/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_left_daughter.qs";
