...
TEST(bartBMA_deepstate_test,find_obs_to_update_grow_test){
  ...
  std::string prior_tree_matrix_temp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/find_obs_to_update_grow/libFuzzer_find_obs_to_update_grow/libfuzzer_inputs/" + std::to_string(current_timestamp) +
  ...
  std::string left_daughter_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/find_obs_to_update_grow/libFuzzer_find_obs_to_update_grow/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_left_daughter.qs";
  ...
  std::string d_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/find_obs_to_update_grow/libFuzzer_find_obs_to_update_grow/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_d.qs";
  qs::c_qsave(d,d_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "d values: "<< d << std::endl;
  NumericVector ld_obs  = RcppDeepState_NumericVector();
  std::string ld_obs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/find_obs_to_update_grow/libFuzzer_find_obs_to_update_grow/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_ld_obs.qs";
  qs::c_qsave(ld_obs,ld_obs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ld_obs values: "<< ld_obs << std::endl;
  NumericVector rd_obs  = RcppDeepState_NumericVector();
  std::string rd_obs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/find_obs_to_update_grow/libFuzzer_find_obs_to_update_grow/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_rd_obs.qs";
