...
TEST(bartBMA_deepstate_test,find_term_obs_test){
  ...
  std::string tree_matrix_temp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/find_term_obs/AFL_find_term_obs/afl_inputs/" + std::to_string(t) + "_tree_matrix_temp.qs";
  ...
  std::string terminal_node_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/find_term_obs/AFL_find_term_obs/afl_inputs/" + std::to_string(t) + "_terminal_node.qs";
