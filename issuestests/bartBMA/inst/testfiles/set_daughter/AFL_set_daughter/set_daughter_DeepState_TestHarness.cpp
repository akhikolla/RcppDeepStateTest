...
TEST(bartBMA_deepstate_test,set_daughter_test){
  ...
  std::string left_daughter_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/set_daughter/AFL_set_daughter/afl_inputs/" + std::to_string(t) + "_left_daughter.qs";
  ...
  std::string right_daughter_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/set_daughter/AFL_set_daughter/afl_inputs/" + std::to_string(t) + "_right_daughter.qs";
  ...
  std::string ld_obs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/set_daughter/AFL_set_daughter/afl_inputs/" + std::to_string(t) + "_ld_obs.qs";
  qs::c_qsave(ld_obs,ld_obs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ld_obs values: "<< ld_obs << std::endl;
  IntegerVector rd_obs  = RcppDeepState_IntegerVector();
  std::string rd_obs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/set_daughter/AFL_set_daughter/afl_inputs/" + std::to_string(t) + "_rd_obs.qs";
  ...
  std::string tree_matrix_temp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/set_daughter/AFL_set_daughter/afl_inputs/" + std::to_string(t) + "_tree_matrix_temp.qs";
  ...
  std::string term_cols_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/set_daughter/AFL_set_daughter/afl_inputs/" + std::to_string(t) + "_term_cols.qs";
