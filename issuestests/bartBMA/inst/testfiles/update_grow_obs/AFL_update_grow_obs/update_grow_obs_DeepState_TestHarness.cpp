...
TEST(bartBMA_deepstate_test,update_grow_obs_test){
  ...
  std::string prior_tree_matrix_temp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/update_grow_obs/AFL_update_grow_obs/afl_inputs/" + std::to_string(t) + "_prior_tree_matrix_temp.qs";
  ...
  std::string grow_node_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/update_grow_obs/AFL_update_grow_obs/afl_inputs/" + std::to_string(t) + "_grow_node.qs";
  ...
  std::string left_daughter_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/update_grow_obs/AFL_update_grow_obs/afl_inputs/" + std::to_string(t) + "_left_daughter.qs";
  qs::c_qsave(left_daughter,left_daughter_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "left_daughter values: "<< left_daughter << std::endl;
  IntegerVector d(1);
  d[0]  = RcppDeepState_int();
  std::string d_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/update_grow_obs/AFL_update_grow_obs/afl_inputs/" + std::to_string(t) + "_d.qs";
  qs::c_qsave(d,d_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "d values: "<< d << std::endl;
  NumericVector ld_obs  = RcppDeepState_NumericVector();
  std::string ld_obs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/update_grow_obs/AFL_update_grow_obs/afl_inputs/" + std::to_string(t) + "_ld_obs.qs";
  qs::c_qsave(ld_obs,ld_obs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ld_obs values: "<< ld_obs << std::endl;
  NumericVector rd_obs  = RcppDeepState_NumericVector();
  std::string rd_obs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/update_grow_obs/AFL_update_grow_obs/afl_inputs/" + std::to_string(t) + "_rd_obs.qs";
