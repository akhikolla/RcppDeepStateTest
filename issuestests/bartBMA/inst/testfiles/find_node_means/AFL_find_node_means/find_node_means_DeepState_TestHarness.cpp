...
TEST(bartBMA_deepstate_test,find_node_means_test){
  ...
  std::string sum_tree_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/find_node_means/AFL_find_node_means/afl_inputs/" + std::to_string(t) + "_sum_tree.qs";
  ...
  std::string term_nodes_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/find_node_means/AFL_find_node_means/afl_inputs/" + std::to_string(t) + "_term_nodes.qs";
