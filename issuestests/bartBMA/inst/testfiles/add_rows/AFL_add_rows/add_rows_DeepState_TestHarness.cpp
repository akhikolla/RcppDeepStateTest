...
TEST(bartBMA_deepstate_test,add_rows_test){
  ...
  std::string prior_tree_table_temp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/add_rows/AFL_add_rows/afl_inputs/" + std::to_string(t) + "_prior_tree_table_temp.qs";
  ...
  std::string grow_node_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/add_rows/AFL_add_rows/afl_inputs/" + std::to_string(t) + "_grow_node.qs";
