...
TEST(bartBMA_deepstate_test,get_imp_vars_test){
  ...
  std::string split_vars_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/get_imp_vars/AFL_get_imp_vars/afl_inputs/" + std::to_string(t) + "_split_vars.qs";
  ...
  std::string num_col_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/get_imp_vars/AFL_get_imp_vars/afl_inputs/" + std::to_string(t) + "_num_col.qs";
  ...
  std::string current_vars_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/get_imp_vars/AFL_get_imp_vars/afl_inputs/" + std::to_string(t) + "_current_vars.qs";
