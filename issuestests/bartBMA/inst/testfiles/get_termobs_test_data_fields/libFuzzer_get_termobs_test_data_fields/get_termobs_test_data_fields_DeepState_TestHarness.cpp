...
TEST(bartBMA_deepstate_test,get_termobs_test_data_fields_test){
  ...
  std::string test_data_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/get_termobs_test_data_fields/libFuzzer_get_termobs_test_data_fields/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_test_data.qs";
  ...
  std::string tree_data_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bartBMA/inst/testfiles/get_termobs_test_data_fields/libFuzzer_get_termobs_test_data_fields/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_tree_data.qs";
