...
TEST(apcf_deepstate_test,pcf_envelope_test){
  ...
  std::string sim_t = "/home/akhila/fuzzer_packages/fuzzedpackages/apcf/inst/testfiles/pcf_envelope/AFL_pcf_envelope/afl_inputs/" + std::to_string(t) + "_sim.qs";
  qs::c_qsave(sim,sim_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "sim values: "<< sim << std::endl;
  NumericVector dist  = RcppDeepState_NumericVector();
  std::string dist_t = "/home/akhila/fuzzer_packages/fuzzedpackages/apcf/inst/testfiles/pcf_envelope/AFL_pcf_envelope/afl_inputs/" + std::to_string(t) + "_dist.qs";
  qs::c_qsave(dist,dist_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dist values: "<< dist << std::endl;
  NumericVector ratio  = RcppDeepState_NumericVector();
  std::string ratio_t = "/home/akhila/fuzzer_packages/fuzzedpackages/apcf/inst/testfiles/pcf_envelope/AFL_pcf_envelope/afl_inputs/" + std::to_string(t) + "_ratio.qs";
  qs::c_qsave(ratio,ratio_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ratio values: "<< ratio << std::endl;
  NumericVector rs  = RcppDeepState_NumericVector();
  std::string rs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/apcf/inst/testfiles/pcf_envelope/AFL_pcf_envelope/afl_inputs/" + std::to_string(t) + "_rs.qs";
  qs::c_qsave(rs,rs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "rs values: "<< rs << std::endl;
  NumericVector area(1);
  area[0]  = RcppDeepState_double();
  std::string area_t = "/home/akhila/fuzzer_packages/fuzzedpackages/apcf/inst/testfiles/pcf_envelope/AFL_pcf_envelope/afl_inputs/" + std::to_string(t) + "_area.qs";
  qs::c_qsave(area,area_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "area values: "<< area << std::endl;
  IntegerVector nobj(1);
  nobj[0]  = RcppDeepState_int();
  std::string nobj_t = "/home/akhila/fuzzer_packages/fuzzedpackages/apcf/inst/testfiles/pcf_envelope/AFL_pcf_envelope/afl_inputs/" + std::to_string(t) + "_nobj.qs";
  qs::c_qsave(nobj,nobj_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nobj values: "<< nobj << std::endl;
  NumericVector stoyan(1);
  stoyan[0]  = RcppDeepState_double();
  std::string stoyan_t = "/home/akhila/fuzzer_packages/fuzzedpackages/apcf/inst/testfiles/pcf_envelope/AFL_pcf_envelope/afl_inputs/" + std::to_string(t) + "_stoyan.qs";
  qs::c_qsave(stoyan,stoyan_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "stoyan values: "<< stoyan << std::endl;
  IntegerVector nrank(1);
  nrank[0]  = RcppDeepState_int();
  std::string nrank_t = "/home/akhila/fuzzer_packages/fuzzedpackages/apcf/inst/testfiles/pcf_envelope/AFL_pcf_envelope/afl_inputs/" + std::to_string(t) + "_nrank.qs";
