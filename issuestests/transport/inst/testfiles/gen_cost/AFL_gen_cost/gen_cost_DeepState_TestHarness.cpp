...
TEST(transport_deepstate_test,gen_cost_test){
  ...
  std::string AR_t = "/home/akhila/fuzzer_packages/fuzzedpackages/transport/inst/testfiles/gen_cost/AFL_gen_cost/afl_inputs/" + std::to_string(t) + "_AR.qs";
  qs::c_qsave(AR,AR_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "AR values: "<< AR << std::endl;
  NumericMatrix BR  = RcppDeepState_NumericMatrix();
  std::string BR_t = "/home/akhila/fuzzer_packages/fuzzedpackages/transport/inst/testfiles/gen_cost/AFL_gen_cost/afl_inputs/" + std::to_string(t) + "_BR.qs";
  qs::c_qsave(BR,BR_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "BR values: "<< BR << std::endl;
  IntegerVector threads(1);
  threads[0]  = RcppDeepState_int();
  std::string threads_t = "/home/akhila/fuzzer_packages/fuzzedpackages/transport/inst/testfiles/gen_cost/AFL_gen_cost/afl_inputs/" + std::to_string(t) + "_threads.qs";
