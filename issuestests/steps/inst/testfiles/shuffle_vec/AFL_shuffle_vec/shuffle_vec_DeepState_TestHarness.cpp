...
TEST(steps_deepstate_test,shuffle_vec_test){
  ...
  std::string min_t = "/home/akhila/fuzzer_packages/fuzzedpackages/steps/inst/testfiles/shuffle_vec/AFL_shuffle_vec/afl_inputs/" + std::to_string(t) + "_min.qs";
  qs::c_qsave(min,min_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "min values: "<< min << std::endl;
  IntegerVector max(1);
  max[0]  = RcppDeepState_int();
  std::string max_t = "/home/akhila/fuzzer_packages/fuzzedpackages/steps/inst/testfiles/shuffle_vec/AFL_shuffle_vec/afl_inputs/" + std::to_string(t) + "_max.qs";
