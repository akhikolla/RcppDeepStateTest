...
TEST(steps_deepstate_test,shuffle_vec_test){
  ...
  std::string min_t = "/home/akhila/fuzzer_packages/fuzzedpackages/steps/inst/testfiles/shuffle_vec/libFuzzer_shuffle_vec/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_min.qs";
  ...
  std::string max_t = "/home/akhila/fuzzer_packages/fuzzedpackages/steps/inst/testfiles/shuffle_vec/libFuzzer_shuffle_vec/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_max.qs";
