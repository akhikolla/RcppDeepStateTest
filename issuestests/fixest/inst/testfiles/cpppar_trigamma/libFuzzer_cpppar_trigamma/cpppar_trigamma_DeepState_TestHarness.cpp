...
TEST(fixest_deepstate_test,cpppar_trigamma_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/fixest/inst/testfiles/cpppar_trigamma/libFuzzer_cpppar_trigamma/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_x.qs";
  qs::c_qsave(x,x_t,
  ...
  std::string nthreads_t = "/home/akhila/fuzzer_packages/fuzzedpackages/fixest/inst/testfiles/cpppar_trigamma/libFuzzer_cpppar_trigamma/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_nthreads.qs";
