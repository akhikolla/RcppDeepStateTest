...
TEST(fixest_deepstate_test,cpppar_check_only_0_test){
  ...
  std::string x_mat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/fixest/inst/testfiles/cpppar_check_only_0/libFuzzer_cpppar_check_only_0/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_x_mat.qs";
  qs::c_qsave(x_mat,x_mat_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x_mat values: "<< x_mat << std::endl;
  IntegerVector nthreads(1);
  nthreads[0]  = RcppDeepState_int();
  std::string nthreads_t = "/home/akhila/fuzzer_packages/fuzzedpackages/fixest/inst/testfiles/cpppar_check_only_0/libFuzzer_cpppar_check_only_0/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_nthreads.qs";
