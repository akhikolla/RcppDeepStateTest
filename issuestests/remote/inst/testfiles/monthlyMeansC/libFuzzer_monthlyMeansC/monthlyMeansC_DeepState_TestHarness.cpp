...
TEST(remote_deepstate_test,monthlyMeansC_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/remote/inst/testfiles/monthlyMeansC/libFuzzer_monthlyMeansC/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_x.qs";
  qs::c_qsave(x,x_t,
  ...
  std::string nCycleWindow_t = "/home/akhila/fuzzer_packages/fuzzedpackages/remote/inst/testfiles/monthlyMeansC/libFuzzer_monthlyMeansC/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_nCycleWindow.qs";
