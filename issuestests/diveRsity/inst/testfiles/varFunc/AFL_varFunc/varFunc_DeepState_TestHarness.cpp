...
TEST(diveRsity_deepstate_test,varFunc_test){
  ...
  std::string af_t = "/home/akhila/fuzzer_packages/fuzzedpackages/diveRsity/inst/testfiles/varFunc/AFL_varFunc/afl_inputs/" + std::to_string(t) + "_af.qs";
  qs::c_qsave(af,af_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "af values: "<< af << std::endl;
  NumericVector sHarm(1);
  sHarm[0]  = RcppDeepState_double();
  std::string sHarm_t = "/home/akhila/fuzzer_packages/fuzzedpackages/diveRsity/inst/testfiles/varFunc/AFL_varFunc/afl_inputs/" + std::to_string(t) + "_sHarm.qs";
