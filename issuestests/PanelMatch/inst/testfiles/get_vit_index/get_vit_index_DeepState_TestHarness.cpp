...
TEST(PanelMatch_deepstate_test,get_vit_index_test){
  ...
  qs::c_qsave(t_id_key,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/PanelMatch/inst/testfiles/get_vit_index/inputs/t_id_key.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "t_id_key values: "<< t_id_key << std::endl;
  CharacterVector control_treatment_t_ids  = RcppDeepState_CharacterVector();
  qs::c_qsave(control_treatment_t_ids,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/PanelMatch/inst/testfiles/get_vit_index/inputs/control_treatment_t_ids.qs",
		"high", "zstd", 1, 15, true, 1);
  ...
  qs::c_qsave(control_treatment_set_nums,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/PanelMatch/inst/testfiles/get_vit_index/inputs/control_treatment_set_nums.qs",
		"high", "zstd", 1, 15, true, 1);
