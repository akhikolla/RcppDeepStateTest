...
TEST(CDM_deepstate_test,cdm_rcpp_ideal_resp_pattern_test){
  ...
  std::string qmatrix_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CDM/inst/testfiles/cdm_rcpp_ideal_resp_pattern/AFL_cdm_rcpp_ideal_resp_pattern/afl_inputs/" + std::to_string(t) + "_qmatrix.qs";
  ...
  std::string skillspace_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CDM/inst/testfiles/cdm_rcpp_ideal_resp_pattern/AFL_cdm_rcpp_ideal_resp_pattern/afl_inputs/" + std::to_string(t) + "_skillspace.qs";
