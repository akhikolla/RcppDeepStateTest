...
TEST(CDM_deepstate_test,cdm_rcpp_kli_id_test){
  ...
  std::string pjk_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CDM/inst/testfiles/cdm_rcpp_kli_id/AFL_cdm_rcpp_kli_id/afl_inputs/" + std::to_string(t) + "_pjk.qs";
  qs::c_qsave(pjk,pjk_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "pjk values: "<< pjk << std::endl;
  NumericMatrix sc  = RcppDeepState_NumericMatrix();
  std::string sc_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CDM/inst/testfiles/cdm_rcpp_kli_id/AFL_cdm_rcpp_kli_id/afl_inputs/" + std::to_string(t) + "_sc.qs";
  qs::c_qsave(sc,sc_t,
		"high", "zstd", 1, 15, true, 1);
