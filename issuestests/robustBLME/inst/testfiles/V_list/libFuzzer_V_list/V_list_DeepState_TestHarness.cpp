...
TEST(robustBLME_deepstate_test,V_list_test){
  ...
  std::string sig2_b_t = "/home/akhila/fuzzer_packages/fuzzedpackages/robustBLME/inst/testfiles/V_list/libFuzzer_V_list/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_sig2_b.qs";
  qs::c_qsave(sig2_b,sig2_b_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "sig2_b values: "<< sig2_b << std::endl;
  NumericVector sig2_eps(1);
  sig2_eps[0]  = RcppDeepState_double();
  std::string sig2_eps_t = "/home/akhila/fuzzer_packages/fuzzedpackages/robustBLME/inst/testfiles/V_list/libFuzzer_V_list/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_sig2_eps.qs";
  qs::c_qsave(sig2_eps,sig2_eps_t,
		"high", "zstd", 1, 15, true, 1);
  ...
  std::string m_i_t = "/home/akhila/fuzzer_packages/fuzzedpackages/robustBLME/inst/testfiles/V_list/libFuzzer_V_list/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_m_i.qs";
  qs::c_qsave(m_i,m_i_t,
		"high", "zstd", 1, 15, true, 1);
