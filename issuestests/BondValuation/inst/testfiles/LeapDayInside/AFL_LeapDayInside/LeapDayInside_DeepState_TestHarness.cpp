...
TEST(BondValuation_deepstate_test,LeapDayInside_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/BondValuation/inst/testfiles/LeapDayInside/AFL_LeapDayInside/afl_inputs/" + std::to_string(t) + "_x.qs";
  qs::c_qsave(x,x_t,
