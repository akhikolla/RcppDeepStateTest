...
TEST(WinRatio_deepstate_test,mat_comp_surv_cpp_test){
  ...
  std::string time1_t = "/home/akhila/fuzzer_packages/fuzzedpackages/WinRatio/inst/testfiles/mat_comp_surv_cpp/AFL_mat_comp_surv_cpp/afl_inputs/" + std::to_string(t) + "_time1.qs";
  qs::c_qsave(time1,time1_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "time1 values: "<< time1 << std::endl;
  NumericVector event1  = RcppDeepState_NumericVector();
  std::string event1_t = "/home/akhila/fuzzer_packages/fuzzedpackages/WinRatio/inst/testfiles/mat_comp_surv_cpp/AFL_mat_comp_surv_cpp/afl_inputs/" + std::to_string(t) + "_event1.qs";
  qs::c_qsave(event1,event1_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "event1 values: "<< event1 << std::endl;
  NumericVector time0  = RcppDeepState_NumericVector();
  std::string time0_t = "/home/akhila/fuzzer_packages/fuzzedpackages/WinRatio/inst/testfiles/mat_comp_surv_cpp/AFL_mat_comp_surv_cpp/afl_inputs/" + std::to_string(t) + "_time0.qs";
  qs::c_qsave(time0,time0_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "time0 values: "<< time0 << std::endl;
  NumericVector event0  = RcppDeepState_NumericVector();
  std::string event0_t = "/home/akhila/fuzzer_packages/fuzzedpackages/WinRatio/inst/testfiles/mat_comp_surv_cpp/AFL_mat_comp_surv_cpp/afl_inputs/" + std::to_string(t) + "_event0.qs";
