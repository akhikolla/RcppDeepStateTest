...
TEST(GeDS_deepstate_test,makeRatSplines_test){
  ...
  std::string matrice_t = "/home/akhila/fuzzer_packages/fuzzedpackages/GeDS/inst/testfiles/makeRatSplines/libFuzzer_makeRatSplines/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_matrice.qs";
  qs::c_qsave(matrice,matrice_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "matrice values: "<< matrice << std::endl;
  NumericVector h  = RcppDeepState_NumericVector();
  std::string h_t = "/home/akhila/fuzzer_packages/fuzzedpackages/GeDS/inst/testfiles/makeRatSplines/libFuzzer_makeRatSplines/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_h.qs";
  qs::c_qsave(h,h_t,
		"high", "zstd", 1, 15, true, 1);
