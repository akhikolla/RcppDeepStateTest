...
TEST(GeDS_deepstate_test,makeEpsilonsb_test){
  ...
  std::string data_t = "/home/akhila/fuzzer_packages/fuzzedpackages/GeDS/inst/testfiles/makeEpsilonsb/AFL_makeEpsilonsb/afl_inputs/" + std::to_string(t) + "_data.qs";
  qs::c_qsave(data,data_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "data values: "<< data << std::endl;
  NumericVector Xs  = RcppDeepState_NumericVector();
  std::string Xs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/GeDS/inst/testfiles/makeEpsilonsb/AFL_makeEpsilonsb/afl_inputs/" + std::to_string(t) + "_Xs.qs";
  qs::c_qsave(Xs,Xs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Xs values: "<< Xs << std::endl;
  NumericVector Ys  = RcppDeepState_NumericVector();
  std::string Ys_t = "/home/akhila/fuzzer_packages/fuzzedpackages/GeDS/inst/testfiles/makeEpsilonsb/AFL_makeEpsilonsb/afl_inputs/" + std::to_string(t) + "_Ys.qs";
  qs::c_qsave(Ys,Ys_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Ys values: "<< Ys << std::endl;
  IntegerVector degree(1);
  degree[0]  = RcppDeepState_int();
  std::string degree_t = "/home/akhila/fuzzer_packages/fuzzedpackages/GeDS/inst/testfiles/makeEpsilonsb/AFL_makeEpsilonsb/afl_inputs/" + std::to_string(t) + "_degree.qs";
