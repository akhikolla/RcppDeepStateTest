...
TEST(rankdist_deepstate_test,KendallNeighbour_test){
  ...
  std::string rank_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/rankdist/inst/testfiles/KendallNeighbour/libFuzzer_KendallNeighbour/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_rank.qs";
