...
TEST(swephR_deepstate_test,calc_ut_test){
  ...
  std::string jd_ut_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/calc_ut/AFL_calc_ut/afl_inputs/" + std::to_string(t) + "_jd_ut.qs";
  qs::c_qsave(jd_ut,jd_ut_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "jd_ut values: "<< jd_ut << std::endl;
  IntegerVector ipl  = RcppDeepState_IntegerVector();
  std::string ipl_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/calc_ut/AFL_calc_ut/afl_inputs/" + std::to_string(t) + "_ipl.qs";
  qs::c_qsave(ipl,ipl_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ipl values: "<< ipl << std::endl;
  IntegerVector iflag(1);
  iflag[0]  = RcppDeepState_int();
  std::string iflag_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/calc_ut/AFL_calc_ut/afl_inputs/" + std::to_string(t) + "_iflag.qs";
