...
TEST(swephR_deepstate_test,azalt_test){
  ...
  std::string jd_ut_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/azalt/AFL_azalt/afl_inputs/" + std::to_string(t) + "_jd_ut.qs";
  qs::c_qsave(jd_ut,jd_ut_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "jd_ut values: "<< jd_ut << std::endl;
  IntegerVector coord_flag(1);
  coord_flag[0]  = RcppDeepState_int();
  std::string coord_flag_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/azalt/AFL_azalt/afl_inputs/" + std::to_string(t) + "_coord_flag.qs";
  ...
  std::string geopos_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/azalt/AFL_azalt/afl_inputs/" + std::to_string(t) + "_geopos.qs";
  qs::c_qsave(geopos,geopos_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "geopos values: "<< geopos << std::endl;
  NumericVector atpress(1);
  atpress[0]  = RcppDeepState_double();
  std::string atpress_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/azalt/AFL_azalt/afl_inputs/" + std::to_string(t) + "_atpress.qs";
  qs::c_qsave(atpress,atpress_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "atpress values: "<< atpress << std::endl;
  NumericVector attemp(1);
  attemp[0]  = RcppDeepState_double();
  std::string attemp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/azalt/AFL_azalt/afl_inputs/" + std::to_string(t) + "_attemp.qs";
  qs::c_qsave(attemp,attemp_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "attemp values: "<< attemp << std::endl;
  NumericVector xin  = RcppDeepState_NumericVector();
  std::string xin_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/azalt/AFL_azalt/afl_inputs/" + std::to_string(t) + "_xin.qs";
