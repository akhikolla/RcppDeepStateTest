...
TEST(swephR_deepstate_test,pheno_test){
  ...
  std::string jd_et_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/pheno/AFL_pheno/afl_inputs/" + std::to_string(t) + "_jd_et.qs";
  qs::c_qsave(jd_et,jd_et_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "jd_et values: "<< jd_et << std::endl;
  IntegerVector ipl(1);
  ipl[0]  = RcppDeepState_int();
  std::string ipl_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/pheno/AFL_pheno/afl_inputs/" + std::to_string(t) + "_ipl.qs";
  qs::c_qsave(ipl,ipl_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ipl values: "<< ipl << std::endl;
  IntegerVector ephe_flag(1);
  ephe_flag[0]  = RcppDeepState_int();
  std::string ephe_flag_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/pheno/AFL_pheno/afl_inputs/" + std::to_string(t) + "_ephe_flag.qs";
