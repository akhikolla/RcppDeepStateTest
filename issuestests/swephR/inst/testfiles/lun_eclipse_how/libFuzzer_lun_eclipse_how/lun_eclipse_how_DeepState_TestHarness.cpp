...
TEST(swephR_deepstate_test,lun_eclipse_how_test){
  ...
  std::string jd_ut_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/lun_eclipse_how/libFuzzer_lun_eclipse_how/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_jd_ut.qs";
  ...
  std::string ephe_flag_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/lun_eclipse_how/libFuzzer_lun_eclipse_how/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_ephe_flag.qs";
  ...
  std::string geopos_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/lun_eclipse_how/libFuzzer_lun_eclipse_how/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_geopos.qs";
