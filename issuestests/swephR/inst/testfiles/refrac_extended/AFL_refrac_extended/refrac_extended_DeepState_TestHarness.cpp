...
TEST(swephR_deepstate_test,refrac_extended_test){
  ...
  std::string InAlt_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/refrac_extended/AFL_refrac_extended/afl_inputs/" + std::to_string(t) + "_InAlt.qs";
  qs::c_qsave(InAlt,InAlt_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "InAlt values: "<< InAlt << std::endl;
  NumericVector height(1);
  height[0]  = RcppDeepState_double();
  std::string height_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/refrac_extended/AFL_refrac_extended/afl_inputs/" + std::to_string(t) + "_height.qs";
  qs::c_qsave(height,height_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "height values: "<< height << std::endl;
  NumericVector atpress(1);
  atpress[0]  = RcppDeepState_double();
  std::string atpress_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/refrac_extended/AFL_refrac_extended/afl_inputs/" + std::to_string(t) + "_atpress.qs";
  qs::c_qsave(atpress,atpress_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "atpress values: "<< atpress << std::endl;
  NumericVector attemp(1);
  attemp[0]  = RcppDeepState_double();
  std::string attemp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/refrac_extended/AFL_refrac_extended/afl_inputs/" + std::to_string(t) + "_attemp.qs";
  ...
  std::string lapse_rate_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/refrac_extended/AFL_refrac_extended/afl_inputs/" + std::to_string(t) + "_lapse_rate.qs";
  ...
  std::string calc_flag_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/refrac_extended/AFL_refrac_extended/afl_inputs/" + std::to_string(t) + "_calc_flag.qs";
