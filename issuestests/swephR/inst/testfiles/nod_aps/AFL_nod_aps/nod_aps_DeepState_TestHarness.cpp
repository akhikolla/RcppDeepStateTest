...
TEST(swephR_deepstate_test,nod_aps_test){
  ...
  std::string jd_et_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/nod_aps/AFL_nod_aps/afl_inputs/" + std::to_string(t) + "_jd_et.qs";
  qs::c_qsave(jd_et,jd_et_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "jd_et values: "<< jd_et << std::endl;
  IntegerVector ipl(1);
  ipl[0]  = RcppDeepState_int();
  std::string ipl_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/nod_aps/AFL_nod_aps/afl_inputs/" + std::to_string(t) + "_ipl.qs";
  qs::c_qsave(ipl,ipl_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ipl values: "<< ipl << std::endl;
  IntegerVector iflag(1);
  iflag[0]  = RcppDeepState_int();
  std::string iflag_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/nod_aps/AFL_nod_aps/afl_inputs/" + std::to_string(t) + "_iflag.qs";
  qs::c_qsave(iflag,iflag_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "iflag values: "<< iflag << std::endl;
  IntegerVector method(1);
  method[0]  = RcppDeepState_int();
  std::string method_t = "/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/nod_aps/AFL_nod_aps/afl_inputs/" + std::to_string(t) + "_method.qs";
