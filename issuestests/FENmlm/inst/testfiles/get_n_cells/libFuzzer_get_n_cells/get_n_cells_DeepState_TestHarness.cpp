...
TEST(FENmlm_deepstate_test,get_n_cells_test){
  ...
  std::string index_i_t = "/home/akhila/fuzzer_packages/fuzzedpackages/FENmlm/inst/testfiles/get_n_cells/libFuzzer_get_n_cells/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_index_i.qs";
  ...
  std::string index_j_t = "/home/akhila/fuzzer_packages/fuzzedpackages/FENmlm/inst/testfiles/get_n_cells/libFuzzer_get_n_cells/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_index_j.qs";
