...
TEST(FENmlm_deepstate_test,cpp_table_test){
  ...
  std::string Q_t = "/home/akhila/fuzzer_packages/fuzzedpackages/FENmlm/inst/testfiles/cpp_table/AFL_cpp_table/afl_inputs/" + std::to_string(t) + "_Q.qs";
  qs::c_qsave(Q,Q_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Q values: "<< Q << std::endl;
  IntegerVector dum  = RcppDeepState_IntegerVector();
  std::string dum_t = "/home/akhila/fuzzer_packages/fuzzedpackages/FENmlm/inst/testfiles/cpp_table/AFL_cpp_table/afl_inputs/" + std::to_string(t) + "_dum.qs";
