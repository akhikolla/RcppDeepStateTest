...
TEST(ipft_deepstate_test,ipfEuclidean_test){
  ...
  qs::c_qsave(train,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/ipft/inst/testfiles/ipfEuclidean/inputs/train.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "train values: "<< train << std::endl;
  NumericMatrix test  = RcppDeepState_NumericMatrix();
  qs::c_qsave(test,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/ipft/inst/testfiles/ipfEuclidean/inputs/test.qs",
		"high", "zstd", 1, 15, true, 1);
