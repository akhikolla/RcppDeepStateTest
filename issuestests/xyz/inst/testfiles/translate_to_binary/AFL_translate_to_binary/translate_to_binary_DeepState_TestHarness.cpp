...
TEST(xyz_deepstate_test,translate_to_binary_test){
  ...
  std::string X_t = "/home/akhila/fuzzer_packages/fuzzedpackages/xyz/inst/testfiles/translate_to_binary/AFL_translate_to_binary/afl_inputs/" + std::to_string(t) + "_X.qs";
  qs::c_qsave(X,X_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "X values: "<< X << std::endl;
  IntegerVector max_number_of_iterations(1);
  max_number_of_iterations[0]  = RcppDeepState_int();
  std::string max_number_of_iterations_t = "/home/akhila/fuzzer_packages/fuzzedpackages/xyz/inst/testfiles/translate_to_binary/AFL_translate_to_binary/afl_inputs/" + std::to_string(t) + "_max_number_of_iterations.qs";
