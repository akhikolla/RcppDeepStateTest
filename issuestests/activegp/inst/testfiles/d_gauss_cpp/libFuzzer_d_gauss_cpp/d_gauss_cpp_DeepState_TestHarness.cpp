...
TEST(activegp_deepstate_test,d_gauss_cpp_test){
  ...
  std::string X_t = "/home/akhila/fuzzer_packages/fuzzedpackages/activegp/inst/testfiles/d_gauss_cpp/libFuzzer_d_gauss_cpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_X.qs";
  qs::c_qsave(X,X_t,
  ...
  std::string sigma_t = "/home/akhila/fuzzer_packages/fuzzedpackages/activegp/inst/testfiles/d_gauss_cpp/libFuzzer_d_gauss_cpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_sigma.qs";
