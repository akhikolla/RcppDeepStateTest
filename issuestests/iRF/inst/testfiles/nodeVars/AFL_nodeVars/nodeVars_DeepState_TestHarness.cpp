...
TEST(iRF_deepstate_test,nodeVars_test){
  ...
  std::string varnodes_t = "/home/akhila/fuzzer_packages/fuzzedpackages/iRF/inst/testfiles/nodeVars/AFL_nodeVars/afl_inputs/" + std::to_string(t) + "_varnodes.qs";
  ...
  std::string nrnodes_t = "/home/akhila/fuzzer_packages/fuzzedpackages/iRF/inst/testfiles/nodeVars/AFL_nodeVars/afl_inputs/" + std::to_string(t) + "_nrnodes.qs";
  qs::c_qsave(nrnodes,nrnodes_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nrnodes values: "<< nrnodes << std::endl;
  IntegerVector p(1);
  p[0]  = RcppDeepState_int();
  std::string p_t = "/home/akhila/fuzzer_packages/fuzzedpackages/iRF/inst/testfiles/nodeVars/AFL_nodeVars/afl_inputs/" + std::to_string(t) + "_p.qs";
  qs::c_qsave(p,p_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "p values: "<< p << std::endl;
  IntegerVector parents  = RcppDeepState_IntegerVector();
  std::string p_t = "/home/akhila/fuzzer_packages/fuzzedpackages/iRF/inst/testfiles/nodeVars/AFL_nodeVars/afl_inputs/" + std::to_string(t) + "_p.qs";
  std::string parents_t = "/home/akhila/fuzzer_packages/fuzzedpackages/iRF/inst/testfiles/nodeVars/AFL_nodeVars/afl_inputs/" + std::to_string(t) + "_parents.qs";
  qs::c_qsave(parents,parents_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "parents values: "<< parents << std::endl;
  IntegerVector idcskeep  = RcppDeepState_IntegerVector();
  std::string idcskeep_t = "/home/akhila/fuzzer_packages/fuzzedpackages/iRF/inst/testfiles/nodeVars/AFL_nodeVars/afl_inputs/" + std::to_string(t) + "_idcskeep.qs";
  qs::c_qsave(idcskeep,idcskeep_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "idcskeep values: "<< idcskeep << std::endl;
  IntegerVector nodect  = RcppDeepState_IntegerVector();
  std::string nodect_t = "/home/akhila/fuzzer_packages/fuzzedpackages/iRF/inst/testfiles/nodeVars/AFL_nodeVars/afl_inputs/" + std::to_string(t) + "_nodect.qs";
  qs::c_qsave(nodect,nodect_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nodect values: "<< nodect << std::endl;
  IntegerVector rowoffset(1);
  rowoffset[0]  = RcppDeepState_int();
  std::string rowoffset_t = "/home/akhila/fuzzer_packages/fuzzedpackages/iRF/inst/testfiles/nodeVars/AFL_nodeVars/afl_inputs/" + std::to_string(t) + "_rowoffset.qs";
  ...
  std::string nodevars_t = "/home/akhila/fuzzer_packages/fuzzedpackages/iRF/inst/testfiles/nodeVars/AFL_nodeVars/afl_inputs/" + std::to_string(t) + "_nodevars.qs";
