...
TEST(bcROCsurface_deepstate_test,asyVarVUS_C_test){
  ...
  std::string tt_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bcROCsurface/inst/testfiles/asyVarVUS_C/AFL_asyVarVUS_C/afl_inputs/" + std::to_string(t) + "_tt.qs";
  qs::c_qsave(tt,tt_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "tt values: "<< tt << std::endl;
  NumericMatrix D_hat  = RcppDeepState_NumericMatrix();
  std::string D_hat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bcROCsurface/inst/testfiles/asyVarVUS_C/AFL_asyVarVUS_C/afl_inputs/" + std::to_string(t) + "_D_hat.qs";
  qs::c_qsave(D_hat,D_hat_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "D_hat values: "<< D_hat << std::endl;
  NumericVector mu_hat(1);
  mu_hat[0]  = RcppDeepState_double();
  std::string mu_hat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bcROCsurface/inst/testfiles/asyVarVUS_C/AFL_asyVarVUS_C/afl_inputs/" + std::to_string(t) + "_mu_hat.qs";
  qs::c_qsave(mu_hat,mu_hat_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mu_hat values: "<< mu_hat << std::endl;
  NumericMatrix EstFunc  = RcppDeepState_NumericMatrix();
  std::string EstFunc_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bcROCsurface/inst/testfiles/asyVarVUS_C/AFL_asyVarVUS_C/afl_inputs/" + std::to_string(t) + "_EstFunc.qs";
  qs::c_qsave(EstFunc,EstFunc_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "EstFunc values: "<< EstFunc << std::endl;
  NumericMatrix Hess_inv  = RcppDeepState_NumericMatrix();
  std::string Hess_inv_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bcROCsurface/inst/testfiles/asyVarVUS_C/AFL_asyVarVUS_C/afl_inputs/" + std::to_string(t) + "_Hess_inv.qs";
  ...
  std::string Der_D1_hat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bcROCsurface/inst/testfiles/asyVarVUS_C/AFL_asyVarVUS_C/afl_inputs/" + std::to_string(t) + "_Der_D1_hat.qs";
  ...
  std::string Der_D2_hat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bcROCsurface/inst/testfiles/asyVarVUS_C/AFL_asyVarVUS_C/afl_inputs/" + std::to_string(t) + "_Der_D2_hat.qs";
  ...
  std::string Der_D3_hat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bcROCsurface/inst/testfiles/asyVarVUS_C/AFL_asyVarVUS_C/afl_inputs/" + std::to_string(t) + "_Der_D3_hat.qs";
