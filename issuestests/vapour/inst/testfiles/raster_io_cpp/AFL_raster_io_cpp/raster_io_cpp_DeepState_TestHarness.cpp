...
TEST(vapour_deepstate_test,raster_io_cpp_test){
  ...
  std::string filename_t = "/home/akhila/fuzzer_packages/fuzzedpackages/vapour/inst/testfiles/raster_io_cpp/AFL_raster_io_cpp/afl_inputs/" + std::to_string(t) + "_filename.qs";
  ...
  std::string window_t = "/home/akhila/fuzzer_packages/fuzzedpackages/vapour/inst/testfiles/raster_io_cpp/AFL_raster_io_cpp/afl_inputs/" + std::to_string(t) + "_window.qs";
  qs::c_qsave(window,window_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "window values: "<< window << std::endl;
  IntegerVector band  = RcppDeepState_IntegerVector();
  std::string band_t = "/home/akhila/fuzzer_packages/fuzzedpackages/vapour/inst/testfiles/raster_io_cpp/AFL_raster_io_cpp/afl_inputs/" + std::to_string(t) + "_band.qs";
  qs::c_qsave(band,band_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "band values: "<< band << std::endl;
  CharacterVector resample  = RcppDeepState_CharacterVector();
  std::string resample_t = "/home/akhila/fuzzer_packages/fuzzedpackages/vapour/inst/testfiles/raster_io_cpp/AFL_raster_io_cpp/afl_inputs/" + std::to_string(t) + "_resample.qs";
