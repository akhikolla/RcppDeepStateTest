...
TEST(icosa_deepstate_test,Aggregate__test){
  ...
  std::string gridPoints_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icosa/inst/testfiles/Aggregate_/AFL_Aggregate_/afl_inputs/" + std::to_string(t) + "_gridPoints.qs";
  ...
  std::string queries_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icosa/inst/testfiles/Aggregate_/AFL_Aggregate_/afl_inputs/" + std::to_string(t) + "_queries.qs";
  qs::c_qsave(queries,queries_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "queries values: "<< queries << std::endl;
  NumericVector origin  = RcppDeepState_NumericVector();
  std::string origin_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icosa/inst/testfiles/Aggregate_/AFL_Aggregate_/afl_inputs/" + std::to_string(t) + "_origin.qs";
