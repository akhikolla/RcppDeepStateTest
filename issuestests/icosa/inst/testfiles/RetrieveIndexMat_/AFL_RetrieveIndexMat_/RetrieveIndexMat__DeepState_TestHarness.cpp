...
TEST(icosa_deepstate_test,RetrieveIndexMat__test){
  ...
  std::string indices_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icosa/inst/testfiles/RetrieveIndexMat_/AFL_RetrieveIndexMat_/afl_inputs/" + std::to_string(t) + "_indices.qs";
