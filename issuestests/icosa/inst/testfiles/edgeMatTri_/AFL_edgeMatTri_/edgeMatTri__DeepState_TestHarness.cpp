...
TEST(icosa_deepstate_test,edgeMatTri__test){
  ...
  std::string v_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icosa/inst/testfiles/edgeMatTri_/AFL_edgeMatTri_/afl_inputs/" + std::to_string(t) + "_v.qs";
  qs::c_qsave(v,v_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "v values: "<< v << std::endl;
  NumericMatrix e  = RcppDeepState_NumericMatrix();
  std::string e_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icosa/inst/testfiles/edgeMatTri_/AFL_edgeMatTri_/afl_inputs/" + std::to_string(t) + "_e.qs";
  qs::c_qsave(e,e_t,
		"high", "zstd", 1, 15, true, 1);
