...
TEST(icosa_deepstate_test,orderTriGrid__test){
  ...
  std::string faces_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icosa/inst/testfiles/orderTriGrid_/AFL_orderTriGrid_/afl_inputs/" + std::to_string(t) + "_faces.qs";
  qs::c_qsave(faces,faces_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "faces values: "<< faces << std::endl;
  NumericMatrix neigh  = RcppDeepState_NumericMatrix();
  std::string neigh_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icosa/inst/testfiles/orderTriGrid_/AFL_orderTriGrid_/afl_inputs/" + std::to_string(t) + "_neigh.qs";
  qs::c_qsave(neigh,neigh_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "neigh values: "<< neigh << std::endl;
  NumericVector startFaces  = RcppDeepState_NumericVector();
  std::string startFaces_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icosa/inst/testfiles/orderTriGrid_/AFL_orderTriGrid_/afl_inputs/" + std::to_string(t) + "_startFaces.qs";
  ...
  std::string startVert_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icosa/inst/testfiles/orderTriGrid_/AFL_orderTriGrid_/afl_inputs/" + std::to_string(t) + "_startVert.qs";
  ...
  std::string nBelts_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icosa/inst/testfiles/orderTriGrid_/AFL_orderTriGrid_/afl_inputs/" + std::to_string(t) + "_nBelts.qs";
  qs::c_qsave(nBelts,nBelts_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nBelts values: "<< nBelts << std::endl;
  IntegerVector nV(1);
  nV[0]  = RcppDeepState_int();
  std::string nV_t = "/home/akhila/fuzzer_packages/fuzzedpackages/icosa/inst/testfiles/orderTriGrid_/AFL_orderTriGrid_/afl_inputs/" + std::to_string(t) + "_nV.qs";
  qs::c_qsave(nV,nV_t,
		"high", "zstd", 1, 15, true, 1);
