...
TEST(starvz_deepstate_test,integrateStepFunc_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/starvz/inst/testfiles/integrateStepFunc/AFL_integrateStepFunc/afl_inputs/" + std::to_string(t) + "_x.qs";
  qs::c_qsave(x,x_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x values: "<< x << std::endl;
  NumericVector bounds  = RcppDeepState_NumericVector();
  std::string bounds_t = "/home/akhila/fuzzer_packages/fuzzedpackages/starvz/inst/testfiles/integrateStepFunc/AFL_integrateStepFunc/afl_inputs/" + std::to_string(t) + "_bounds.qs";
  qs::c_qsave(bounds,bounds_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "bounds values: "<< bounds << std::endl;
  NumericVector values  = RcppDeepState_NumericVector();
  std::string values_t = "/home/akhila/fuzzer_packages/fuzzedpackages/starvz/inst/testfiles/integrateStepFunc/AFL_integrateStepFunc/afl_inputs/" + std::to_string(t) + "_values.qs";
