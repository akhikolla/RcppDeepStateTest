...
TEST(GPareto_deepstate_test,nonDomInd_cpp_test){
  ...
  std::string mat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/GPareto/inst/testfiles/nonDomInd_cpp/libFuzzer_nonDomInd_cpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_mat.qs";
