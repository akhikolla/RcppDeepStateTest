...
TEST(ivsacim_deepstate_test,ivsacim_est_test){
  ...
  std::string time_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ivsacim/inst/testfiles/ivsacim_est/AFL_ivsacim_est/afl_inputs/" + std::to_string(t) + "_time.qs";
  qs::c_qsave(time,time_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "time values: "<< time << std::endl;
  NumericVector event  = RcppDeepState_NumericVector();
  std::string event_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ivsacim/inst/testfiles/ivsacim_est/AFL_ivsacim_est/afl_inputs/" + std::to_string(t) + "_event.qs";
  qs::c_qsave(event,event_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "event values: "<< event << std::endl;
  NumericVector stime  = RcppDeepState_NumericVector();
  std::string stime_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ivsacim/inst/testfiles/ivsacim_est/AFL_ivsacim_est/afl_inputs/" + std::to_string(t) + "_stime.qs";
  qs::c_qsave(stime,stime_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "stime values: "<< stime << std::endl;
  NumericVector Zc  = RcppDeepState_NumericVector();
  std::string Zc_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ivsacim/inst/testfiles/ivsacim_est/AFL_ivsacim_est/afl_inputs/" + std::to_string(t) + "_Zc.qs";
  qs::c_qsave(Zc,Zc_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Zc values: "<< Zc << std::endl;
  NumericMatrix D_status  = RcppDeepState_NumericMatrix();
  std::string D_status_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ivsacim/inst/testfiles/ivsacim_est/AFL_ivsacim_est/afl_inputs/" + std::to_string(t) + "_D_status.qs";
  qs::c_qsave(D_status,D_status_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "D_status values: "<< D_status << std::endl;
  NumericMatrix eps_2  = RcppDeepState_NumericMatrix();
  std::string eps_2_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ivsacim/inst/testfiles/ivsacim_est/AFL_ivsacim_est/afl_inputs/" + std::to_string(t) + "_eps_2.qs";
  qs::c_qsave(eps_2,eps_2_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "eps_2 values: "<< eps_2 << std::endl;
  NumericMatrix Zc_dot  = RcppDeepState_NumericMatrix();
  std::string Zc_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ivsacim/inst/testfiles/ivsacim_est/AFL_ivsacim_est/afl_inputs/" + std::to_string(t) + "_Zc.qs";
  std::string Zc_dot_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ivsacim/inst/testfiles/ivsacim_est/AFL_ivsacim_est/afl_inputs/" + std::to_string(t) + "_Zc_dot.qs";
