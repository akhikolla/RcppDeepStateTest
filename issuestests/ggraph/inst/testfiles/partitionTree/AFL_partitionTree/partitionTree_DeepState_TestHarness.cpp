...
TEST(ggraph_deepstate_test,partitionTree_test){
  ...
  std::string parent_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ggraph/inst/testfiles/partitionTree/AFL_partitionTree/afl_inputs/" + std::to_string(t) + "_parent.qs";
  qs::c_qsave(parent,parent_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "parent values: "<< parent << std::endl;
  IntegerVector order  = RcppDeepState_IntegerVector();
  std::string order_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ggraph/inst/testfiles/partitionTree/AFL_partitionTree/afl_inputs/" + std::to_string(t) + "_order.qs";
  qs::c_qsave(order,order_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "order values: "<< order << std::endl;
  NumericVector weight  = RcppDeepState_NumericVector();
  std::string weight_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ggraph/inst/testfiles/partitionTree/AFL_partitionTree/afl_inputs/" + std::to_string(t) + "_weight.qs";
  qs::c_qsave(weight,weight_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "weight values: "<< weight << std::endl;
  NumericVector height  = RcppDeepState_NumericVector();
  std::string height_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ggraph/inst/testfiles/partitionTree/AFL_partitionTree/afl_inputs/" + std::to_string(t) + "_height.qs";
