...
TEST(ggraph_deepstate_test,splitTreemap_test){
  ...
  std::string parent_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ggraph/inst/testfiles/splitTreemap/AFL_splitTreemap/afl_inputs/" + std::to_string(t) + "_parent.qs";
  qs::c_qsave(parent,parent_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "parent values: "<< parent << std::endl;
  IntegerVector order  = RcppDeepState_IntegerVector();
  std::string order_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ggraph/inst/testfiles/splitTreemap/AFL_splitTreemap/afl_inputs/" + std::to_string(t) + "_order.qs";
  qs::c_qsave(order,order_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "order values: "<< order << std::endl;
  NumericVector weight  = RcppDeepState_NumericVector();
  std::string weight_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ggraph/inst/testfiles/splitTreemap/AFL_splitTreemap/afl_inputs/" + std::to_string(t) + "_weight.qs";
  qs::c_qsave(weight,weight_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "weight values: "<< weight << std::endl;
  NumericVector width(1);
  width[0]  = RcppDeepState_double();
  std::string width_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ggraph/inst/testfiles/splitTreemap/AFL_splitTreemap/afl_inputs/" + std::to_string(t) + "_width.qs";
  qs::c_qsave(width,width_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "width values: "<< width << std::endl;
  NumericVector height(1);
  height[0]  = RcppDeepState_double();
  std::string height_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ggraph/inst/testfiles/splitTreemap/AFL_splitTreemap/afl_inputs/" + std::to_string(t) + "_height.qs";
