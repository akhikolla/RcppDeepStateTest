...
TEST(immer_deepstate_test,sample_prob_index_test){
  ...
  qs::c_qsave(probs,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/immer/inst/testfiles/sample_prob_index/inputs/probs.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "probs values: "<< probs << std::endl;
  NumericVector rn  = RcppDeepState_NumericVector();
  qs::c_qsave(rn,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/immer/inst/testfiles/sample_prob_index/inputs/rn.qs",
		"high", "zstd", 1, 15, true, 1);
