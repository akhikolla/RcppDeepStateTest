...
TEST(immer_deepstate_test,immer_cml_extract_parmindex_test){
  ...
  std::string esf_par0_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/immer/inst/testfiles/immer_cml_extract_parmindex/libFuzzer_immer_cml_extract_parmindex/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_esf_par0.qs";
  ...
  std::string parm_index_pp_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/immer/inst/testfiles/immer_cml_extract_parmindex/libFuzzer_immer_cml_extract_parmindex/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_parm_index_pp.qs";
