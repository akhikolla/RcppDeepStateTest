...
TEST(ksNN_deepstate_test,rcpp_ksNN_test){
  ...
  std::string Label_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ksNN/inst/testfiles/rcpp_ksNN/AFL_rcpp_ksNN/afl_inputs/" + std::to_string(t) + "_Label.qs";
  qs::c_qsave(Label,Label_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Label values: "<< Label << std::endl;
  NumericVector Distance  = RcppDeepState_NumericVector();
  std::string Distance_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ksNN/inst/testfiles/rcpp_ksNN/AFL_rcpp_ksNN/afl_inputs/" + std::to_string(t) + "_Distance.qs";
  qs::c_qsave(Distance,Distance_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Distance values: "<< Distance << std::endl;
  NumericVector L_C(1);
  L_C[0]  = RcppDeepState_double();
  std::string L_C_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ksNN/inst/testfiles/rcpp_ksNN/AFL_rcpp_ksNN/afl_inputs/" + std::to_string(t) + "_L_C.qs";
