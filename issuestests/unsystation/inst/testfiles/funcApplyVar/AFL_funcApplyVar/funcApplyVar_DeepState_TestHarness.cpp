...
TEST(unsystation_deepstate_test,funcApplyVar_test){
  ...
  std::string nullStatMat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/unsystation/inst/testfiles/funcApplyVar/AFL_funcApplyVar/afl_inputs/" + std::to_string(t) + "_nullStatMat.qs";
  ...
  std::string maxLevel_t = "/home/akhila/fuzzer_packages/fuzzedpackages/unsystation/inst/testfiles/funcApplyVar/AFL_funcApplyVar/afl_inputs/" + std::to_string(t) + "_maxLevel.qs";
  qs::c_qsave(maxLevel,maxLevel_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "maxLevel values: "<< maxLevel << std::endl;
  IntegerVector Msq(1);
  Msq[0]  = RcppDeepState_int();
  std::string Msq_t = "/home/akhila/fuzzer_packages/fuzzedpackages/unsystation/inst/testfiles/funcApplyVar/AFL_funcApplyVar/afl_inputs/" + std::to_string(t) + "_Msq.qs";
