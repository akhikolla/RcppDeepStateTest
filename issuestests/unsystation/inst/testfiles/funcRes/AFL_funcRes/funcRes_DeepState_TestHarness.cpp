...
TEST(unsystation_deepstate_test,funcRes_test){
  ...
  std::string yMat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/unsystation/inst/testfiles/funcRes/AFL_funcRes/afl_inputs/" + std::to_string(t) + "_yMat.qs";
  qs::c_qsave(yMat,yMat_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "yMat values: "<< yMat << std::endl;
  IntegerVector M(1);
  M[0]  = RcppDeepState_int();
  std::string M_t = "/home/akhila/fuzzer_packages/fuzzedpackages/unsystation/inst/testfiles/funcRes/AFL_funcRes/afl_inputs/" + std::to_string(t) + "_M.qs";
  qs::c_qsave(M,M_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "M values: "<< M << std::endl;
  IntegerVector minLength(1);
  minLength[0]  = RcppDeepState_int();
  std::string minLength_t = "/home/akhila/fuzzer_packages/fuzzedpackages/unsystation/inst/testfiles/funcRes/AFL_funcRes/afl_inputs/" + std::to_string(t) + "_minLength.qs";
  ...
  std::string probVec_t = "/home/akhila/fuzzer_packages/fuzzedpackages/unsystation/inst/testfiles/funcRes/AFL_funcRes/afl_inputs/" + std::to_string(t) + "_probVec.qs";
  qs::c_qsave(probVec,probVec_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "probVec values: "<< probVec << std::endl;
  IntegerVector topCand  = RcppDeepState_IntegerVector();
  std::string topCand_t = "/home/akhila/fuzzer_packages/fuzzedpackages/unsystation/inst/testfiles/funcRes/AFL_funcRes/afl_inputs/" + std::to_string(t) + "_topCand.qs";
  qs::c_qsave(topCand,topCand_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "topCand values: "<< topCand << std::endl;
  IntegerVector bottomCand  = RcppDeepState_IntegerVector();
  std::string bottomCand_t = "/home/akhila/fuzzer_packages/fuzzedpackages/unsystation/inst/testfiles/funcRes/AFL_funcRes/afl_inputs/" + std::to_string(t) + "_bottomCand.qs";
  ...
  std::string var_t = "/home/akhila/fuzzer_packages/fuzzedpackages/unsystation/inst/testfiles/funcRes/AFL_funcRes/afl_inputs/" + std::to_string(t) + "_var.qs";
