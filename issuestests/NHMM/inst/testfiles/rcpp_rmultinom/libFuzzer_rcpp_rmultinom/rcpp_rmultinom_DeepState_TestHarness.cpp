...
TEST(NHMM_deepstate_test,rcpp_rmultinom_test){
  ...
  std::string probs_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/NHMM/inst/testfiles/rcpp_rmultinom/libFuzzer_rcpp_rmultinom/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_probs.qs";
