...
TEST(abcADM_deepstate_test,modifynPerTheta_test){
  ...
  qs::c_qsave(newnPerTheta,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/abcADM/inst/testfiles/modifynPerTheta/inputs/newnPerTheta.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "newnPerTheta values: "<< newnPerTheta << std::endl;
  IntegerVector verbose(1);
  verbose[0]  = RcppDeepState_int();
  qs::c_qsave(verbose,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/abcADM/inst/testfiles/modifynPerTheta/inputs/verbose.qs",
		"high", "zstd", 1, 15, true, 1);
