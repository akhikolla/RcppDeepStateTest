...
TEST(wkutils_deepstate_test,cpp_wkt_has_missing_test){
  ...
  std::string wkt_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/wkutils/inst/testfiles/cpp_wkt_has_missing/AFL_cpp_wkt_has_missing/afl_inputs/" + std::to_string(t) + "_wkt.qs";
