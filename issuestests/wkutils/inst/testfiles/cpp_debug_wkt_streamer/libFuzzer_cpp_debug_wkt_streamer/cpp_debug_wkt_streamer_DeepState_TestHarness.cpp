...
TEST(wkutils_deepstate_test,cpp_debug_wkt_streamer_test){
  ...
  std::string input_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/wkutils/inst/testfiles/cpp_debug_wkt_streamer/libFuzzer_cpp_debug_wkt_streamer/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_input.qs";
