...
TEST(imagerExtra_deepstate_test,make_histogram_fuzzy_test){
  ...
  std::string ordered_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/imagerExtra/inst/testfiles/make_histogram_fuzzy/AFL_make_histogram_fuzzy/afl_inputs/" + std::to_string(t) + "_ordered.qs";
  ...
  std::string interval_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/imagerExtra/inst/testfiles/make_histogram_fuzzy/AFL_make_histogram_fuzzy/afl_inputs/" + std::to_string(t) + "_interval.qs";
