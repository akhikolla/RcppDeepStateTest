...
TEST(imagerExtra_deepstate_test,IDCT2D_retrievex_test){
  ...
  std::string mat_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/imagerExtra/inst/testfiles/IDCT2D_retrievex/libFuzzer_IDCT2D_retrievex/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_mat.qs";
