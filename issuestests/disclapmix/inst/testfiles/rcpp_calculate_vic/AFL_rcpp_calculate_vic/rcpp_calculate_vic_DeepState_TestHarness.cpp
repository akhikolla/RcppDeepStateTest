...
TEST(disclapmix_deepstate_test,rcpp_calculate_vic_test){
  ...
  std::string wic_t = "/home/akhila/fuzzer_packages/fuzzedpackages/disclapmix/inst/testfiles/rcpp_calculate_vic/AFL_rcpp_calculate_vic/afl_inputs/" + std::to_string(t) + "_wic.qs";
