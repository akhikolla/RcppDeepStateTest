...
TEST(Umatrix_deepstate_test,bestmatchC_test){
  ...
  std::string WeightVectors_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/Umatrix/inst/testfiles/bestmatchC/AFL_bestmatchC/afl_inputs/" + std::to_string(t) + "_WeightVectors.qs";
  ...
  std::string DataPoint_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/Umatrix/inst/testfiles/bestmatchC/AFL_bestmatchC/afl_inputs/" + std::to_string(t) + "_DataPoint.qs";
