...
TEST(BAMBI_deepstate_test,calc_corr_tau_2_test){
  ...
  samp_mat_stream.open("/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/BAMBI/inst/testfiles/calc_corr_tau_2/inputs/samp_mat");
