...
TEST(imager_deepstate_test,HSItoRGB_test){
  ...
  std::string im_t = "/home/akhila/fuzzer_packages/fuzzedpackages/imager/inst/testfiles/HSItoRGB/libFuzzer_HSItoRGB/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_im.qs";
  qs::c_qsave(im,im_t,
