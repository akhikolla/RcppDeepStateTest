...
TEST(imager_deepstate_test,erode_square_test){
  ...
  std::string im_t = "/home/akhila/fuzzer_packages/fuzzedpackages/imager/inst/testfiles/erode_square/AFL_erode_square/afl_inputs/" + std::to_string(t) + "_im.qs";
  qs::c_qsave(im,im_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "im values: "<< im << std::endl;
  IntegerVector size(1);
  size[0]  = RcppDeepState_int();
  std::string size_t = "/home/akhila/fuzzer_packages/fuzzedpackages/imager/inst/testfiles/erode_square/AFL_erode_square/afl_inputs/" + std::to_string(t) + "_size.qs";
