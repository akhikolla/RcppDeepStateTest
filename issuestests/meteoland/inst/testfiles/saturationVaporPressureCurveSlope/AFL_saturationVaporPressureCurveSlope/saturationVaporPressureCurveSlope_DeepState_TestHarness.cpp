...
TEST(meteoland_deepstate_test,saturationVaporPressureCurveSlope_test){
  ...
  std::string temperature_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/meteoland/inst/testfiles/saturationVaporPressureCurveSlope/AFL_saturationVaporPressureCurveSlope/afl_inputs/" + std::to_string(t) + "_temperature.qs";
