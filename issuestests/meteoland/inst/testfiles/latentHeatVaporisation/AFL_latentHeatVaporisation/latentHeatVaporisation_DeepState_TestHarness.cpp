...
TEST(meteoland_deepstate_test,latentHeatVaporisation_test){
  ...
  std::string temperature_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/meteoland/inst/testfiles/latentHeatVaporisation/AFL_latentHeatVaporisation/afl_inputs/" + std::to_string(t) + "_temperature.qs";
