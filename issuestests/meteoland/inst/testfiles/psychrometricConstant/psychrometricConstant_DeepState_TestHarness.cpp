...
TEST(meteoland_deepstate_test,psychrometricConstant_test){
  ...
  qs::c_qsave(temperature,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/meteoland/inst/testfiles/psychrometricConstant/inputs/temperature.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "temperature values: "<< temperature << std::endl;
  NumericVector Patm(1);
  Patm[0]  = RcppDeepState_double();
  qs::c_qsave(Patm,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/meteoland/inst/testfiles/psychrometricConstant/inputs/Patm.qs",
		"high", "zstd", 1, 15, true, 1);
