...
TEST(meteoland_deepstate_test,saturationVapourPressure_test){
  ...
  std::string temperature_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/meteoland/inst/testfiles/saturationVapourPressure/libFuzzer_saturationVapourPressure/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_temperature.qs";
