...
TEST(flexpolyline_deepstate_test,encode_test){
  ...
  std::string line_t = "/home/akhila/fuzzer_packages/fuzzedpackages/flexpolyline/inst/testfiles/encode/AFL_encode/afl_inputs/" + std::to_string(t) + "_line.qs";
  qs::c_qsave(line,line_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "line values: "<< line << std::endl;
  IntegerVector precision(1);
  precision[0]  = RcppDeepState_int();
  std::string precision_t = "/home/akhila/fuzzer_packages/fuzzedpackages/flexpolyline/inst/testfiles/encode/AFL_encode/afl_inputs/" + std::to_string(t) + "_precision.qs";
  ...
  std::string third_dim_t = "/home/akhila/fuzzer_packages/fuzzedpackages/flexpolyline/inst/testfiles/encode/AFL_encode/afl_inputs/" + std::to_string(t) + "_third_dim.qs";
  ...
  std::string third_dim_t = "/home/akhila/fuzzer_packages/fuzzedpackages/flexpolyline/inst/testfiles/encode/AFL_encode/afl_inputs/" + std::to_string(t) + "_third_dim.qs";
  std::string third_dim_precision_t = "/home/akhila/fuzzer_packages/fuzzedpackages/flexpolyline/inst/testfiles/encode/AFL_encode/afl_inputs/" + std::to_string(t) + "_third_dim_precision.qs";
