...
TEST(autothresholdr_deepstate_test,mean_pillars_test){
  ...
  std::string arr3d_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/autothresholdr/inst/testfiles/mean_pillars/AFL_mean_pillars/afl_inputs/" + std::to_string(t) + "_arr3d.qs";
