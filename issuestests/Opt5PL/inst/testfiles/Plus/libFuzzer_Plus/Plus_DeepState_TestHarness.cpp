...
TEST(Opt5PL_deepstate_test,Plus_test){
  ...
  std::string M1_t = "/home/akhila/fuzzer_packages/fuzzedpackages/Opt5PL/inst/testfiles/Plus/libFuzzer_Plus/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_M1.qs";
  qs::c_qsave(M1,M1_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "M1 values: "<< M1 << std::endl;
  NumericMatrix M2  = RcppDeepState_NumericMatrix();
  std::string M2_t = "/home/akhila/fuzzer_packages/fuzzedpackages/Opt5PL/inst/testfiles/Plus/libFuzzer_Plus/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_M2.qs";
  qs::c_qsave(M2,M2_t,
		"high", "zstd", 1, 15, true, 1);
