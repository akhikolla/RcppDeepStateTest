...
TEST(pcIRT_deepstate_test,gamfunk_test){
  ...
  qs::c_qsave(epsmat,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/pcIRT/inst/testfiles/gamfunk/inputs/epsmat.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "epsmat values: "<< epsmat << std::endl;
  NumericMatrix gammat  = RcppDeepState_NumericMatrix();
  qs::c_qsave(gammat,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/pcIRT/inst/testfiles/gamfunk/inputs/gammat.qs",
		"high", "zstd", 1, 15, true, 1);
