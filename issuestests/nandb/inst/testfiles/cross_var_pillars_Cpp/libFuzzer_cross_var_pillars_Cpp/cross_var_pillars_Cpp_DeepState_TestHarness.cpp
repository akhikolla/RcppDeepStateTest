...
TEST(nandb_deepstate_test,cross_var_pillars_Cpp_test){
  ...
  std::string x3d_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nandb/inst/testfiles/cross_var_pillars_Cpp/libFuzzer_cross_var_pillars_Cpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_x3d.qs";
  qs::c_qsave(x3d,x3d_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x3d values: "<< x3d << std::endl;
  NumericVector y3d  = RcppDeepState_NumericVector();
  std::string y3d_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nandb/inst/testfiles/cross_var_pillars_Cpp/libFuzzer_cross_var_pillars_Cpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_y3d.qs";
