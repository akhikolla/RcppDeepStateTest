...
TEST(adheRenceRX_deepstate_test,episode_checkCpp_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/adheRenceRX/inst/testfiles/episode_checkCpp/AFL_episode_checkCpp/afl_inputs/" + std::to_string(t) + "_x.qs";
  qs::c_qsave(x,x_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x values: "<< x << std::endl;
  IntegerVector perm_gap(1);
  perm_gap[0]  = RcppDeepState_int();
  std::string perm_gap_t = "/home/akhila/fuzzer_packages/fuzzedpackages/adheRenceRX/inst/testfiles/episode_checkCpp/AFL_episode_checkCpp/afl_inputs/" + std::to_string(t) + "_perm_gap.qs";
  ...
  std::string init_rank_t = "/home/akhila/fuzzer_packages/fuzzedpackages/adheRenceRX/inst/testfiles/episode_checkCpp/AFL_episode_checkCpp/afl_inputs/" + std::to_string(t) + "_init_rank.qs";
