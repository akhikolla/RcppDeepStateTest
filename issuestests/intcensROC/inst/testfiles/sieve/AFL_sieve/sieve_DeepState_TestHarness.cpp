...
TEST(intcensROC_deepstate_test,sieve_test){
  ...
  std::string Utmp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/sieve/AFL_sieve/afl_inputs/" + std::to_string(t) + "_Utmp.qs";
  qs::c_qsave(Utmp,Utmp_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Utmp values: "<< Utmp << std::endl;
  NumericVector Vtmp  = RcppDeepState_NumericVector();
  std::string Vtmp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/sieve/AFL_sieve/afl_inputs/" + std::to_string(t) + "_Vtmp.qs";
  qs::c_qsave(Vtmp,Vtmp_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Vtmp values: "<< Vtmp << std::endl;
  NumericVector Markertmp  = RcppDeepState_NumericVector();
  std::string Markertmp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/sieve/AFL_sieve/afl_inputs/" + std::to_string(t) + "_Markertmp.qs";
  ...
  std::string Deltatmp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/sieve/AFL_sieve/afl_inputs/" + std::to_string(t) + "_Deltatmp.qs";
  qs::c_qsave(Deltatmp,Deltatmp_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Deltatmp values: "<< Deltatmp << std::endl;
  NumericVector KnotI  = RcppDeepState_NumericVector();
  std::string KnotI_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/sieve/AFL_sieve/afl_inputs/" + std::to_string(t) + "_KnotI.qs";
  qs::c_qsave(KnotI,KnotI_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "KnotI values: "<< KnotI << std::endl;
  NumericVector KnotM  = RcppDeepState_NumericVector();
  std::string KnotM_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/sieve/AFL_sieve/afl_inputs/" + std::to_string(t) + "_KnotM.qs";
  qs::c_qsave(KnotM,KnotM_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "KnotM values: "<< KnotM << std::endl;
  IntegerVector ki(1);
  ki[0]  = RcppDeepState_int();
  std::string ki_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/sieve/AFL_sieve/afl_inputs/" + std::to_string(t) + "_ki.qs";
  qs::c_qsave(ki,ki_t,
		"high", "zstd", 1, 15, true, 1);
