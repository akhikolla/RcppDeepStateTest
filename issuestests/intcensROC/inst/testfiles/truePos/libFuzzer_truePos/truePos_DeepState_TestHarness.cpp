...
TEST(intcensROC_deepstate_test,truePos_test){
  ...
  std::string thetaTmp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/truePos/libFuzzer_truePos/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_thetaTmp.qs";
  ...
  std::string mtmp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/truePos/libFuzzer_truePos/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_mtmp.qs";
  ...
  std::string max_m_tmp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/truePos/libFuzzer_truePos/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_max_m_tmp.qs";
  ...
  std::string ttmp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/truePos/libFuzzer_truePos/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_ttmp.qs";
  qs::c_qsave(ttmp,ttmp_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ttmp values: "<< ttmp << std::endl;
  NumericVector KnotI  = RcppDeepState_NumericVector();
  std::string KnotI_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/truePos/libFuzzer_truePos/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_KnotI.qs";
  qs::c_qsave(KnotI,KnotI_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "KnotI values: "<< KnotI << std::endl;
  NumericVector KnotM  = RcppDeepState_NumericVector();
  std::string KnotM_t = "/home/akhila/fuzzer_packages/fuzzedpackages/intcensROC/inst/testfiles/truePos/libFuzzer_truePos/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_KnotM.qs";
