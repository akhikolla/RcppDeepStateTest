...
TEST(bsearchtools_deepstate_test,ubCharacter_test){
  ...
  qs::c_qsave(sortedValues,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/bsearchtools/inst/testfiles/ubCharacter/inputs/sortedValues.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "sortedValues values: "<< sortedValues << std::endl;
  CharacterVector valueToSearch  = RcppDeepState_CharacterVector();
  qs::c_qsave(valueToSearch,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/bsearchtools/inst/testfiles/ubCharacter/inputs/valueToSearch.qs",
		"high", "zstd", 1, 15, true, 1);
