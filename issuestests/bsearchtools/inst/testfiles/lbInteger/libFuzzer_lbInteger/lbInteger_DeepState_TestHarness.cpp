...
TEST(bsearchtools_deepstate_test,lbInteger_test){
  ...
  std::string sortedValues_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/bsearchtools/inst/testfiles/lbInteger/libFuzzer_lbInteger/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_sortedValues.qs";
  ...
  std::string valueToSearch_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/bsearchtools/inst/testfiles/lbInteger/libFuzzer_lbInteger/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_valueToSearch.qs";
