...
TEST(bsearchtools_deepstate_test,ubInteger_test){
  ...
  qs::c_qsave(sortedValues,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/bsearchtools/inst/testfiles/ubInteger/inputs/sortedValues.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "sortedValues values: "<< sortedValues << std::endl;
  IntegerVector valueToSearch(1);
  valueToSearch[0]  = RcppDeepState_int();
  qs::c_qsave(valueToSearch,"/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/bsearchtools/inst/testfiles/ubInteger/inputs/valueToSearch.qs",
		"high", "zstd", 1, 15, true, 1);
