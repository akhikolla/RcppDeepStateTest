...
TEST(bsearchtools_deepstate_test,lbCharacter_test){
  ...
  std::string sortedValues_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/bsearchtools/inst/testfiles/lbCharacter/libFuzzer_lbCharacter/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_sortedValues.qs";
  ...
  std::string valueToSearch_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/bsearchtools/inst/testfiles/lbCharacter/libFuzzer_lbCharacter/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_valueToSearch.qs";
