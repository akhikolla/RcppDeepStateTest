...
TEST(ibs_deepstate_test,bsbasesCpp_test){
  ...
  std::string xs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ibs/inst/testfiles/bsbasesCpp/libFuzzer_bsbasesCpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_xs.qs";
  qs::c_qsave(xs,xs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "xs values: "<< xs << std::endl;
  NumericVector kns  = RcppDeepState_NumericVector();
  std::string kns_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ibs/inst/testfiles/bsbasesCpp/libFuzzer_bsbasesCpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_kns.qs";
  ...
  std::string order_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ibs/inst/testfiles/bsbasesCpp/libFuzzer_bsbasesCpp/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_order.qs";
