...
TEST(AGread_deepstate_test,interpolate_C_test){
  ...
  std::string original_samples_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/AGread/inst/testfiles/interpolate_C/AFL_interpolate_C/afl_inputs/" + std::to_string(t) + "_original_samples.qs";
  ...
  std::string target_frequency_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/AGread/inst/testfiles/interpolate_C/AFL_interpolate_C/afl_inputs/" + std::to_string(t) + "_target_frequency.qs";
