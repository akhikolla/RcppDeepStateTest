...
TEST(AGread_deepstate_test,interpolate_C_test){
  ...
  std::string original_samples_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/AGread/inst/testfiles/interpolate_C/libFuzzer_interpolate_C/libfuzzer_inputs/" + std::to_string(current_timestamp) +
  ...
  std::string target_frequency_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/AGread/inst/testfiles/interpolate_C/libFuzzer_interpolate_C/libfuzzer_inputs/" + std::to_string(current_timestamp) +
