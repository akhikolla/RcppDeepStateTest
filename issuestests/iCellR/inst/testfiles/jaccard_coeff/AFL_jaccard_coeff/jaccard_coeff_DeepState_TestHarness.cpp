...
TEST(iCellR_deepstate_test,jaccard_coeff_test){
  ...
  std::string idx_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/iCellR/inst/testfiles/jaccard_coeff/AFL_jaccard_coeff/afl_inputs/" + std::to_string(t) + "_idx.qs";
