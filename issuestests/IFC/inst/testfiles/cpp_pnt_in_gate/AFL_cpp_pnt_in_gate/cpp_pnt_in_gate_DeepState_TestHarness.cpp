...
TEST(IFC_deepstate_test,cpp_pnt_in_gate_test){
  ...
  std::string pnts_t = "/home/akhila/fuzzer_packages/fuzzedpackages/IFC/inst/testfiles/cpp_pnt_in_gate/AFL_cpp_pnt_in_gate/afl_inputs/" + std::to_string(t) + "_pnts.qs";
  qs::c_qsave(pnts,pnts_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "pnts values: "<< pnts << std::endl;
  NumericMatrix gate  = RcppDeepState_NumericMatrix();
  std::string gate_t = "/home/akhila/fuzzer_packages/fuzzedpackages/IFC/inst/testfiles/cpp_pnt_in_gate/AFL_cpp_pnt_in_gate/afl_inputs/" + std::to_string(t) + "_gate.qs";
  qs::c_qsave(gate,gate_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "gate values: "<< gate << std::endl;
  IntegerVector algorithm(1);
  algorithm[0]  = RcppDeepState_int();
  std::string algorithm_t = "/home/akhila/fuzzer_packages/fuzzedpackages/IFC/inst/testfiles/cpp_pnt_in_gate/AFL_cpp_pnt_in_gate/afl_inputs/" + std::to_string(t) + "_algorithm.qs";
  ...
  std::string epsilon_t = "/home/akhila/fuzzer_packages/fuzzedpackages/IFC/inst/testfiles/cpp_pnt_in_gate/AFL_cpp_pnt_in_gate/afl_inputs/" + std::to_string(t) + "_epsilon.qs";
