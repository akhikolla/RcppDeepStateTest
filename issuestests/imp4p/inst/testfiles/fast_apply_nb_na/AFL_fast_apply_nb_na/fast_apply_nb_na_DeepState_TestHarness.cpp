...
TEST(imp4p_deepstate_test,fast_apply_nb_na_test){
  ...
  std::string X_t = "/home/akhila/fuzzer_packages/fuzzedpackages/imp4p/inst/testfiles/fast_apply_nb_na/AFL_fast_apply_nb_na/afl_inputs/" + std::to_string(t) + "_X.qs";
  qs::c_qsave(X,X_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "X values: "<< X << std::endl;
  IntegerVector dim(1);
  dim[0]  = RcppDeepState_int();
  std::string dim_t = "/home/akhila/fuzzer_packages/fuzzedpackages/imp4p/inst/testfiles/fast_apply_nb_na/AFL_fast_apply_nb_na/afl_inputs/" + std::to_string(t) + "_dim.qs";
