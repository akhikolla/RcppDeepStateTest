...
TEST(cytometree_deepstate_test,FmeasureC_no0_test){
  ...
  std::string pred_t = "/home/akhila/fuzzer_packages/fuzzedpackages/cytometree/inst/testfiles/FmeasureC_no0/libFuzzer_FmeasureC_no0/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_pred.qs";
  qs::c_qsave(pred,pred_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "pred values: "<< pred << std::endl;
  NumericVector ref  = RcppDeepState_NumericVector();
  std::string ref_t = "/home/akhila/fuzzer_packages/fuzzedpackages/cytometree/inst/testfiles/FmeasureC_no0/libFuzzer_FmeasureC_no0/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_ref.qs";
