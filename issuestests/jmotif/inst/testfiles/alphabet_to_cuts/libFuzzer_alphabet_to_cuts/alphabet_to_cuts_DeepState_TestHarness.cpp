...
TEST(jmotif_deepstate_test,alphabet_to_cuts_test){
  ...
  std::string a_size_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/jmotif/inst/testfiles/alphabet_to_cuts/libFuzzer_alphabet_to_cuts/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_a_size.qs";
