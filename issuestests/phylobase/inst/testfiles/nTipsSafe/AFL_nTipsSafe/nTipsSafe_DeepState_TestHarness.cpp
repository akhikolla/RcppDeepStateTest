...
TEST(phylobase_deepstate_test,nTipsSafe_test){
  ...
  std::string ances_t = "/home/akhila/R/x86_64-pc-linux-gnu-library/3.6/RcppDeepState/extdata/issuestests/phylobase/inst/testfiles/nTipsSafe/AFL_nTipsSafe/afl_inputs/" + std::to_string(t) + "_ances.qs";
