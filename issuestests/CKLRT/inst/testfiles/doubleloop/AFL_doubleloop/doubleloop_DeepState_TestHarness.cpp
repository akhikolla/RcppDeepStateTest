...
TEST(CKLRT_deepstate_test,doubleloop_test){
  ...
  std::string K1R_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop/AFL_doubleloop/afl_inputs/" + std::to_string(t) + "_K1R.qs";
  qs::c_qsave(K1R,K1R_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "K1R values: "<< K1R << std::endl;
  NumericMatrix K2R  = RcppDeepState_NumericMatrix();
  std::string K2R_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop/AFL_doubleloop/afl_inputs/" + std::to_string(t) + "_K2R.qs";
  qs::c_qsave(K2R,K2R_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "K2R values: "<< K2R << std::endl;
  NumericMatrix P0R  = RcppDeepState_NumericMatrix();
  std::string P0R_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop/AFL_doubleloop/afl_inputs/" + std::to_string(t) + "_P0R.qs";
  qs::c_qsave(P0R,P0R_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "P0R values: "<< P0R << std::endl;
  NumericMatrix AR  = RcppDeepState_NumericMatrix();
  std::string AR_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop/AFL_doubleloop/afl_inputs/" + std::to_string(t) + "_AR.qs";
  qs::c_qsave(AR,AR_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "AR values: "<< AR << std::endl;
  NumericMatrix U1R  = RcppDeepState_NumericMatrix();
  std::string U1R_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop/AFL_doubleloop/afl_inputs/" + std::to_string(t) + "_U1R.qs";
  qs::c_qsave(U1R,U1R_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "U1R values: "<< U1R << std::endl;
  NumericMatrix wR  = RcppDeepState_NumericMatrix();
  std::string wR_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop/AFL_doubleloop/afl_inputs/" + std::to_string(t) + "_wR.qs";
  qs::c_qsave(wR,wR_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "wR values: "<< wR << std::endl;
  NumericVector LamdasR  = RcppDeepState_NumericVector();
  std::string LamdasR_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop/AFL_doubleloop/afl_inputs/" + std::to_string(t) + "_LamdasR.qs";
  qs::c_qsave(LamdasR,LamdasR_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "LamdasR values: "<< LamdasR << std::endl;
  IntegerVector nminuspx(1);
  nminuspx[0]  = RcppDeepState_int();
  std::string nminuspx_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop/AFL_doubleloop/afl_inputs/" + std::to_string(t) + "_nminuspx.qs";
  ...
  std::string all_rho_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop/AFL_doubleloop/afl_inputs/" + std::to_string(t) + "_all_rho.qs";
  ...
  std::string LR0_allRhoR_t = "/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop/AFL_doubleloop/afl_inputs/" + std::to_string(t) + "_LR0_allRhoR.qs";
