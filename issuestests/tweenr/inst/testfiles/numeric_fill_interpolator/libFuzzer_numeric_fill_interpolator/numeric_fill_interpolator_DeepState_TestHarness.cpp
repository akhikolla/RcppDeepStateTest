...
TEST(tweenr_deepstate_test,numeric_fill_interpolator_test){
  ...
  std::string data_t = "/home/akhila/fuzzer_packages/fuzzedpackages/tweenr/inst/testfiles/numeric_fill_interpolator/libFuzzer_numeric_fill_interpolator/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_data.qs";
  qs::c_qsave(data,data_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "data values: "<< data << std::endl;
  CharacterVector ease  = RcppDeepState_CharacterVector();
  std::string ease_t = "/home/akhila/fuzzer_packages/fuzzedpackages/tweenr/inst/testfiles/numeric_fill_interpolator/libFuzzer_numeric_fill_interpolator/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_ease.qs";
