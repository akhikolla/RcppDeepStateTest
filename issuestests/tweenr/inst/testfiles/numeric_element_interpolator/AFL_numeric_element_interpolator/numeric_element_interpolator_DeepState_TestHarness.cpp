...
TEST(tweenr_deepstate_test,numeric_element_interpolator_test){
  ...
  std::string data_t = "/home/akhila/fuzzer_packages/fuzzedpackages/tweenr/inst/testfiles/numeric_element_interpolator/AFL_numeric_element_interpolator/afl_inputs/" + std::to_string(t) + "_data.qs";
  qs::c_qsave(data,data_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "data values: "<< data << std::endl;
  CharacterVector group  = RcppDeepState_CharacterVector();
  std::string group_t = "/home/akhila/fuzzer_packages/fuzzedpackages/tweenr/inst/testfiles/numeric_element_interpolator/AFL_numeric_element_interpolator/afl_inputs/" + std::to_string(t) + "_group.qs";
  qs::c_qsave(group,group_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "group values: "<< group << std::endl;
  IntegerVector frame  = RcppDeepState_IntegerVector();
  std::string frame_t = "/home/akhila/fuzzer_packages/fuzzedpackages/tweenr/inst/testfiles/numeric_element_interpolator/AFL_numeric_element_interpolator/afl_inputs/" + std::to_string(t) + "_frame.qs";
  qs::c_qsave(frame,frame_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "frame values: "<< frame << std::endl;
  CharacterVector ease  = RcppDeepState_CharacterVector();
  std::string ease_t = "/home/akhila/fuzzer_packages/fuzzedpackages/tweenr/inst/testfiles/numeric_element_interpolator/AFL_numeric_element_interpolator/afl_inputs/" + std::to_string(t) + "_ease.qs";
