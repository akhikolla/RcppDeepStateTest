...
TEST(openxlsx_deepstate_test,map_cell_types_to_integer_test){
  ...
  std::string t_t = "/home/akhila/fuzzer_packages/fuzzedpackages/openxlsx/inst/testfiles/map_cell_types_to_integer/AFL_map_cell_types_to_integer/afl_inputs/" + std::to_string(t) + "_t.qs";
  qs::c_qsave(t,t_t,
