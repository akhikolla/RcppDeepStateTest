...
TEST(dfphase1_deepstate_test,ggrank_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/dfphase1/inst/testfiles/ggrank/libFuzzer_ggrank/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_x.qs";
  qs::c_qsave(x,x_t,
