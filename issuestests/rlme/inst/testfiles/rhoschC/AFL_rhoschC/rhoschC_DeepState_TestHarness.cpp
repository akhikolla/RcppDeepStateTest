...
TEST(rlme_deepstate_test,rhoschC_test){
  ...
  std::string ahat_t = "/home/akhila/fuzzer_packages/fuzzedpackages/rlme/inst/testfiles/rhoschC/AFL_rhoschC/afl_inputs/" + std::to_string(t) + "_ahat.qs";
  qs::c_qsave(ahat,ahat_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "ahat values: "<< ahat << std::endl;
  NumericVector section_counts  = RcppDeepState_NumericVector();
  std::string section_counts_t = "/home/akhila/fuzzer_packages/fuzzedpackages/rlme/inst/testfiles/rhoschC/AFL_rhoschC/afl_inputs/" + std::to_string(t) + "_section_counts.qs";
  ...
  std::string student_counts_t = "/home/akhila/fuzzer_packages/fuzzedpackages/rlme/inst/testfiles/rhoschC/AFL_rhoschC/afl_inputs/" + std::to_string(t) + "_student_counts.qs";
