...
TEST(hutilscpp_deepstate_test,do_pmax0_bitwise_test){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/hutilscpp/inst/testfiles/do_pmax0_bitwise/libFuzzer_do_pmax0_bitwise/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_x.qs";
  qs::c_qsave(x,x_t,
  ...
  std::string nThread_t = "/home/akhila/fuzzer_packages/fuzzedpackages/hutilscpp/inst/testfiles/do_pmax0_bitwise/libFuzzer_do_pmax0_bitwise/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_nThread.qs";
