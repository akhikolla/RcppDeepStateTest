...
TEST(redist_deepstate_test,declination_test){
  ...
  std::string dvs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/redist/inst/testfiles/declination/AFL_declination/afl_inputs/" + std::to_string(t) + "_dvs.qs";
  qs::c_qsave(dvs,dvs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dvs values: "<< dvs << std::endl;
  IntegerVector dseat_vec  = RcppDeepState_IntegerVector();
  std::string dseat_vec_t = "/home/akhila/fuzzer_packages/fuzzedpackages/redist/inst/testfiles/declination/AFL_declination/afl_inputs/" + std::to_string(t) + "_dseat_vec.qs";
  qs::c_qsave(dseat_vec,dseat_vec_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dseat_vec values: "<< dseat_vec << std::endl;
  IntegerVector nd(1);
  nd[0]  = RcppDeepState_int();
  std::string nd_t = "/home/akhila/fuzzer_packages/fuzzedpackages/redist/inst/testfiles/declination/AFL_declination/afl_inputs/" + std::to_string(t) + "_nd.qs";
  qs::c_qsave(nd,nd_t,
		"high", "zstd", 1, 15, true, 1);
