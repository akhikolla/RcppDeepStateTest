...
TEST(redist_deepstate_test,declination_test){
  ...
  std::string dvs_t = "/home/akhila/fuzzer_packages/fuzzedpackages/redist/inst/testfiles/declination/libFuzzer_declination/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_dvs.qs";
  qs::c_qsave(dvs,dvs_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dvs values: "<< dvs << std::endl;
  IntegerVector dseat_vec  = RcppDeepState_IntegerVector();
  std::string dseat_vec_t = "/home/akhila/fuzzer_packages/fuzzedpackages/redist/inst/testfiles/declination/libFuzzer_declination/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_dseat_vec.qs";
  ...
  std::string nd_t = "/home/akhila/fuzzer_packages/fuzzedpackages/redist/inst/testfiles/declination/libFuzzer_declination/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_nd.qs";
  qs::c_qsave(nd,nd_t,
		"high", "zstd", 1, 15, true, 1);
