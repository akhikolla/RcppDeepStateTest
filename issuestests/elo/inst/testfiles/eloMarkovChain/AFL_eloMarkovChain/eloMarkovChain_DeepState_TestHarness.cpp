...
TEST(elo_deepstate_test,eloMarkovChain_test){
  ...
  std::string teamA_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloMarkovChain/AFL_eloMarkovChain/afl_inputs/" + std::to_string(t) + "_teamA.qs";
  qs::c_qsave(teamA,teamA_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "teamA values: "<< teamA << std::endl;
  NumericMatrix teamB  = RcppDeepState_NumericMatrix();
  std::string teamB_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloMarkovChain/AFL_eloMarkovChain/afl_inputs/" + std::to_string(t) + "_teamB.qs";
  qs::c_qsave(teamB,teamB_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "teamB values: "<< teamB << std::endl;
  NumericVector winsA  = RcppDeepState_NumericVector();
  std::string winsA_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloMarkovChain/AFL_eloMarkovChain/afl_inputs/" + std::to_string(t) + "_winsA.qs";
  qs::c_qsave(winsA,winsA_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "winsA values: "<< winsA << std::endl;
  NumericVector weightsA  = RcppDeepState_NumericVector();
  std::string weightsA_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloMarkovChain/AFL_eloMarkovChain/afl_inputs/" + std::to_string(t) + "_weightsA.qs";
  std::string weights_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloMarkovChain/AFL_eloMarkovChain/afl_inputs/" + std::to_string(t) + "_weights.qs";
  ...
  std::string weightsB_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloMarkovChain/AFL_eloMarkovChain/afl_inputs/" + std::to_string(t) + "_weightsB.qs";
  std::string weights_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloMarkovChain/AFL_eloMarkovChain/afl_inputs/" + std::to_string(t) + "_weights.qs";
  ...
  std::string k_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloMarkovChain/AFL_eloMarkovChain/afl_inputs/" + std::to_string(t) + "_k.qs";
  qs::c_qsave(k,k_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "k values: "<< k << std::endl;
  IntegerVector nTeams(1);
  nTeams[0]  = RcppDeepState_int();
  std::string nTeams_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloMarkovChain/AFL_eloMarkovChain/afl_inputs/" + std::to_string(t) + "_nTeams.qs";
