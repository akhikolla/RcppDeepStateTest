...
TEST(elo_deepstate_test,eloWinPct_test){
  ...
  std::string winsA_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloWinPct/libFuzzer_eloWinPct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_winsA.qs";
  qs::c_qsave(winsA,winsA_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "winsA values: "<< winsA << std::endl;
  NumericMatrix teamA  = RcppDeepState_NumericMatrix();
  std::string teamA_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloWinPct/libFuzzer_eloWinPct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_teamA.qs";
  qs::c_qsave(teamA,teamA_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "teamA values: "<< teamA << std::endl;
  NumericMatrix teamB  = RcppDeepState_NumericMatrix();
  std::string teamB_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloWinPct/libFuzzer_eloWinPct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_teamB.qs";
  qs::c_qsave(teamB,teamB_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "teamB values: "<< teamB << std::endl;
  NumericVector weightsA  = RcppDeepState_NumericVector();
  std::string weightsA_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloWinPct/libFuzzer_eloWinPct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_weightsA.qs";
  std::string weights_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloWinPct/libFuzzer_eloWinPct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_weights.qs";
  ...
  std::string weightsB_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloWinPct/libFuzzer_eloWinPct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_weightsB.qs";
  std::string weights_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloWinPct/libFuzzer_eloWinPct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_weights.qs";
  ...
  std::string nTeams_t = "/home/akhila/fuzzer_packages/fuzzedpackages/elo/inst/testfiles/eloWinPct/libFuzzer_eloWinPct/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_nTeams.qs";
