...
TEST(selectiveInference_deepstate_test,solve_barrier__test){
  ...
  std::string conjugate_arg_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_barrier_/AFL_solve_barrier_/afl_inputs/" + std::to_string(t) + "_conjugate_arg.qs";
  ...
  std::string precision_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_barrier_/AFL_solve_barrier_/afl_inputs/" + std::to_string(t) + "_precision.qs";
  ...
  std::string feasible_point_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_barrier_/AFL_solve_barrier_/afl_inputs/" + std::to_string(t) + "_feasible_point.qs";
  ...
  std::string max_iter_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_barrier_/AFL_solve_barrier_/afl_inputs/" + std::to_string(t) + "_max_iter.qs";
  ...
  std::string min_iter_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_barrier_/AFL_solve_barrier_/afl_inputs/" + std::to_string(t) + "_min_iter.qs";
  ...
  std::string value_tol_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_barrier_/AFL_solve_barrier_/afl_inputs/" + std::to_string(t) + "_value_tol.qs";
  ...
  std::string initial_step_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_barrier_/AFL_solve_barrier_/afl_inputs/" + std::to_string(t) + "_initial_step.qs";
