...
TEST(selectiveInference_deepstate_test,solve_QP_test){
  ...
  std::string Sigma_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_Sigma.qs";
  qs::c_qsave(Sigma,Sigma_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Sigma values: "<< Sigma << std::endl;
  NumericVector bound(1);
  bound[0]  = RcppDeepState_double();
  std::string bound_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_bound.qs";
  qs::c_qsave(bound,bound_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "bound values: "<< bound << std::endl;
  IntegerVector max_iter(1);
  max_iter[0]  = RcppDeepState_int();
  std::string max_iter_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_max_iter.qs";
  qs::c_qsave(max_iter,max_iter_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "max_iter values: "<< max_iter << std::endl;
  NumericVector theta  = RcppDeepState_NumericVector();
  std::string theta_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_theta.qs";
  qs::c_qsave(theta,theta_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "theta values: "<< theta << std::endl;
  NumericVector linear_func  = RcppDeepState_NumericVector();
  std::string linear_func_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_linear_func.qs";
  ...
  std::string gradient_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_gradient.qs";
  ...
  std::string ever_active_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_ever_active.qs";
  ...
  std::string nactive_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_nactive.qs";
  ...
  std::string kkt_tol_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_kkt_tol.qs";
  ...
  std::string objective_tol_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_objective_tol.qs";
  ...
  std::string parameter_tol_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_parameter_tol.qs";
  ...
  std::string max_active_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_max_active.qs";
  ...
  std::string kkt_stop_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_kkt_stop.qs";
  ...
  std::string objective_stop_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_objective_stop.qs";
  ...
  std::string param_stop_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/solve_QP/AFL_solve_QP/afl_inputs/" + std::to_string(t) + "_param_stop.qs";
