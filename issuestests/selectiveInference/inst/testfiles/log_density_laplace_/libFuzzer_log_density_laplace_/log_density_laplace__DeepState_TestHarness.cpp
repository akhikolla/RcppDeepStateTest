...
TEST(selectiveInference_deepstate_test,log_density_laplace__test){
  ...
  std::string noise_scale_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/log_density_laplace_/libFuzzer_log_density_laplace_/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_noise_scale.qs";
  ...
  std::string internal_linear_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/log_density_laplace_/libFuzzer_log_density_laplace_/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_internal_linear.qs";
  ...
  std::string internal_state_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/log_density_laplace_/libFuzzer_log_density_laplace_/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_internal_state.qs";
  ...
  std::string optimization_linear_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/log_density_laplace_/libFuzzer_log_density_laplace_/libfuzzer_inputs/" + std::to_string(current_timestamp) +
  ...
  std::string optimization_state_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/log_density_laplace_/libFuzzer_log_density_laplace_/libfuzzer_inputs/" + std::to_string(current_timestamp) +
  ...
  std::string offset_t = "/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/log_density_laplace_/libFuzzer_log_density_laplace_/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_offset.qs";
