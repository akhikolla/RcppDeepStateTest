...
std::ofstream  pertube_amp_stream;
 ...
 int height = RcppDeepState_int ();
  height_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ height");
 height_stream<< height;
std::cout <<"height values: "<< height << std::endl;
 height_stream.close();
 int width = RcppDeepState_int ();
  width_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ width");
 width_stream<< width;
std::cout <<"width values: "<< width << std::endl;
 width_stream.close();
 int seed = RcppDeepState_int ();
  seed_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ seed");
 seed_stream<< seed;
std::cout <<"seed values: "<< seed << std::endl;
 seed_stream.close();
 double freq = RcppDeepState_double ();
  freq_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ freq");
 freq_stream<< freq;
std::cout <<"freq values: "<< freq << std::endl;
 freq_stream.close();
 int fractal = RcppDeepState_int ();
  fractal_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ fractal");
 fractal_stream<< fractal;
std::cout <<"fractal values: "<< fractal << std::endl;
 fractal_stream.close();
 int octaves = RcppDeepState_int ();
  octaves_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ octaves");
 octaves_stream<< octaves;
std::cout <<"octaves values: "<< octaves << std::endl;
 octaves_stream.close();
 double lacunarity = RcppDeepState_double ();
  lacunarity_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ lacunarity");
...
std::cout <<"lacunarity values: "<< lacunarity << std::endl;
 ...
 double gain = RcppDeepState_double ();
  gain_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ gain");
 gain_stream<< gain;
std::cout <<"gain values: "<< gain << std::endl;
 gain_stream.close();
 int dist = RcppDeepState_int ();
  dist_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ dist");
 dist_stream<< dist;
std::cout <<"dist values: "<< dist << std::endl;
 dist_stream.close();
 int value = RcppDeepState_int ();
  value_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ value");
 value_stream<< value;
std::cout <<"value values: "<< value << std::endl;
 value_stream.close();
 IntegerVector dist2ind = RcppDeepState_IntegerVector ();
  dist2ind_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ dist2ind");
...
std::cout <<"dist2ind values: "<< dist2ind << std::endl;
 ...
 double jitter = RcppDeepState_double ();
  jitter_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ jitter");
 jitter_stream<< jitter;
std::cout <<"jitter values: "<< jitter << std::endl;
 jitter_stream.close();
 int pertube = RcppDeepState_int ();
  pertube_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ pertube");
...
std::cout <<"pertube values: "<< pertube << std::endl;
 ...
 double pertube_amp = RcppDeepState_double ();
  pertube_amp_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/worley_2d_c/inputs/ pertube_amp");
 pertube_amp_stream<< pertube_amp;
std::cout <<"pertube_amp values: "<< pertube_amp << std::endl;
 pertube_amp_stream.close();
 std::cout << "input ends" << std::endl;
 try{
worley_2d_c( height, width, seed, freq, fractal, octaves, lacunarity, gain, dist, value, dist2ind, jitter, pertube, pertube_amp);
}
