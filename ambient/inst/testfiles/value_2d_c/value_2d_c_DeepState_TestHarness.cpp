...
std::ofstream  pertube_amp_stream;
 ...
 int height = RcppDeepState_int ();
  height_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/value_2d_c/inputs/ height");
 height_stream<< height;
std::cout <<"height values: "<< height << std::endl;
 height_stream.close();
 int width = RcppDeepState_int ();
  width_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/value_2d_c/inputs/ width");
 width_stream<< width;
std::cout <<"width values: "<< width << std::endl;
 width_stream.close();
 int seed = RcppDeepState_int ();
  seed_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/value_2d_c/inputs/ seed");
 seed_stream<< seed;
std::cout <<"seed values: "<< seed << std::endl;
 seed_stream.close();
 double freq = RcppDeepState_double ();
  freq_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/value_2d_c/inputs/ freq");
 freq_stream<< freq;
std::cout <<"freq values: "<< freq << std::endl;
 freq_stream.close();
 int interp = RcppDeepState_int ();
  interp_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/value_2d_c/inputs/ interp");
 interp_stream<< interp;
std::cout <<"interp values: "<< interp << std::endl;
 interp_stream.close();
 int fractal = RcppDeepState_int ();
  fractal_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/value_2d_c/inputs/ fractal");
 fractal_stream<< fractal;
std::cout <<"fractal values: "<< fractal << std::endl;
 fractal_stream.close();
 int octaves = RcppDeepState_int ();
  octaves_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/value_2d_c/inputs/ octaves");
 octaves_stream<< octaves;
std::cout <<"octaves values: "<< octaves << std::endl;
 octaves_stream.close();
 double lacunarity = RcppDeepState_double ();
  lacunarity_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/value_2d_c/inputs/ lacunarity");
...
std::cout <<"lacunarity values: "<< lacunarity << std::endl;
 ...
 double gain = RcppDeepState_double ();
  gain_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/value_2d_c/inputs/ gain");
 gain_stream<< gain;
std::cout <<"gain values: "<< gain << std::endl;
 gain_stream.close();
 int pertube = RcppDeepState_int ();
  pertube_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/value_2d_c/inputs/ pertube");
...
std::cout <<"pertube values: "<< pertube << std::endl;
 ...
 double pertube_amp = RcppDeepState_double ();
  pertube_amp_stream.open("/home/akhila/Documents/compileAttributescheck/ambient/inst/testfiles/value_2d_c/inputs/ pertube_amp");
 pertube_amp_stream<< pertube_amp;
std::cout <<"pertube_amp values: "<< pertube_amp << std::endl;
 pertube_amp_stream.close();
 std::cout << "input ends" << std::endl;
 try{
value_2d_c( height, width, seed, freq, interp, fractal, octaves, lacunarity, gain, pertube, pertube_amp);
}
